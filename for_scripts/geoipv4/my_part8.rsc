...
:do {add list=$AddressList comment=my address=80.93.221.0/24} on-error {}
:do {add list=$AddressList comment=my address=82.117.88.0/24} on-error {}
:do {add list=$AddressList comment=my address=82.158.112.0/24} on-error {}
...
:do {add list=$AddressList comment=my address=85.137.16.0/23} on-error {}
...
:do {add list=$AddressList comment=my address=87.84.164.0/24} on-error {}
...
:do {add list=$AddressList comment=my address=9.129.67.160/27} on-error {}
:do {add list=$AddressList comment=my address=9.176.128.0/20} on-error {}
...
:do {add list=$AddressList comment=my address=95.85.68.0/24} on-error {}
