...
:do {add list=$AddressList comment=tor address=69.62.120.155/32} on-error {}
...
:do {add list=$AddressList comment=tor address=78.17.93.172/31} on-error {}
:do {add list=$AddressList comment=tor address=78.17.93.70/32} on-error {}
:do {add list=$AddressList comment=tor address=78.17.93.91/32} on-error {}
...
:do {add list=$AddressList comment=tor address=80.251.153.113/32} on-error {}
...
:do {add list=$AddressList comment=tor address=82.26.80.150/32} on-error {}
...
:do {add list=$AddressList comment=tor address=83.97.20.159/32} on-error {}
...
:do {add list=$AddressList comment=tor address=86.107.168.183/32} on-error {}
