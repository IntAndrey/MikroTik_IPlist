...
:do {add list=$AddressList comment=ve address=38.172.184.0/24} on-error {}
...
:do {add list=$AddressList comment=ve address=82.86.156.0/23} on-error {}
:do {add list=$AddressList comment=ve address=82.86.159.0/24} on-error {}
