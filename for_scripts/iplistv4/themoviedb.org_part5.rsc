...
:do {add list=$AddressList comment=themoviedb.org address=185.229.190.147} on-error {}
:do {add list=$AddressList comment=themoviedb.org address=185.229.190.148} on-error {}
