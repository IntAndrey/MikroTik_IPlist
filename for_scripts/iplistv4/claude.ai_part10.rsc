...
:do {add list=$AddressList comment=claude.ai address=99.84.91.6} on-error {}
...
:do {add list=$AddressList comment=claude.ai address=99.84.91.67} on-error {}
:do {add list=$AddressList comment=claude.ai address=99.84.91.70} on-error {}
