...
:do {add list=$AddressList comment=AS25715 address=74.188.196.0/22} on-error {}
:do {add list=$AddressList comment=AS25715 address=74.188.200.0/22} on-error {}
:do {add list=$AddressList comment=AS25715 address=74.188.212.0/22} on-error {}
:do {add list=$AddressList comment=AS25715 address=74.188.216.0/21} on-error {}
