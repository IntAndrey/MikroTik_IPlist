...
:do {add list=$AddressList comment=AS153947 address=104.247.222.0/24} on-error {}
...
:do {add list=$AddressList comment=AS153947 address=163.5.215.0/24} on-error {}
:do {add list=$AddressList comment=AS153947 address=167.148.80.0/24} on-error {}
:do {add list=$AddressList comment=AS153947 address=174.140.250.0/24} on-error {}
...
:do {add list=$AddressList comment=AS153947 address=45.43.207.0/24} on-error {}
:do {add list=$AddressList comment=AS153947 address=51.194.173.0/24} on-error {}
:do {add list=$AddressList comment=AS153947 address=82.21.57.0/24} on-error {}
:do {add list=$AddressList comment=AS153947 address=82.25.47.0/24} on-error {}
