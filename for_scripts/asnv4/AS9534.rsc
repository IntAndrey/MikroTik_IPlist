...
:do {add list=$AddressList comment=AS9534 address=202.146.64.0/23} on-error {}
:do {add list=$AddressList comment=AS9534 address=202.146.67.0/24} on-error {}
:do {add list=$AddressList comment=AS9534 address=202.146.68.0/22} on-error {}
:do {add list=$AddressList comment=AS9534 address=202.146.72.0/21} on-error {}
:do {add list=$AddressList comment=AS9534 address=202.146.80.0/20} on-error {}
