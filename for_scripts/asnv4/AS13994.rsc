...
:do {add list=$AddressList comment=AS13994 address=161.115.192.0/20} on-error {}
:do {add list=$AddressList comment=AS13994 address=184.154.224.0/21} on-error {}
:do {add list=$AddressList comment=AS13994 address=184.154.232.0/22} on-error {}
:do {add list=$AddressList comment=AS13994 address=184.154.236.0/23} on-error {}
