...
:do {add list=$AddressList comment=AS57844 address=178.20.227.0/24} on-error {}
:do {add list=$AddressList comment=AS57844 address=178.20.228.0/23} on-error {}
:do {add list=$AddressList comment=AS57844 address=178.20.231.0/24} on-error {}
:do {add list=$AddressList comment=AS57844 address=185.118.143.0/24} on-error {}
