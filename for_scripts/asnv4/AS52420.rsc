...
:do {add list=$AddressList comment=AS52420 address=201.220.145.0/24} on-error {}
:do {add list=$AddressList comment=AS52420 address=201.220.146.0/23} on-error {}
:do {add list=$AddressList comment=AS52420 address=201.220.148.0/22} on-error {}
:do {add list=$AddressList comment=AS52420 address=201.220.152.0/21} on-error {}
