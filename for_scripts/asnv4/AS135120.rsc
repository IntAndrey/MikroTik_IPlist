...
:do {add list=$AddressList comment=AS135120 address=203.210.17.0/24} on-error {}
:do {add list=$AddressList comment=AS135120 address=203.210.18.0/23} on-error {}
...
:do {add list=$AddressList comment=AS135120 address=210.87.196.0/23} on-error {}
:do {add list=$AddressList comment=AS135120 address=210.87.199.0/24} on-error {}
:do {add list=$AddressList comment=AS135120 address=210.87.204.0/24} on-error {}
...
:do {add list=$AddressList comment=AS135120 address=23.27.230.0/24} on-error {}
