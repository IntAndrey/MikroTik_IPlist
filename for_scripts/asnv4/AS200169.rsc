...
:do {add list=$AddressList comment=AS200169 address=140.235.27.0/24} on-error {}
:do {add list=$AddressList comment=AS200169 address=141.11.93.0/24} on-error {}
:do {add list=$AddressList comment=AS200169 address=151.242.192.0/24} on-error {}
:do {add list=$AddressList comment=AS200169 address=151.243.129.0/24} on-error {}
:do {add list=$AddressList comment=AS200169 address=151.244.4.0/24} on-error {}
:do {add list=$AddressList comment=AS200169 address=157.254.130.0/24} on-error {}
:do {add list=$AddressList comment=AS200169 address=16.216.3.0/24} on-error {}
:do {add list=$AddressList comment=AS200169 address=16.217.4.0/24} on-error {}
:do {add list=$AddressList comment=AS200169 address=188.220.7.0/24} on-error {}
:do {add list=$AddressList comment=AS200169 address=212.189.57.0/24} on-error {}
:do {add list=$AddressList comment=AS200169 address=43.230.84.0/24} on-error {}
:do {add list=$AddressList comment=AS200169 address=45.152.242.0/24} on-error {}
:do {add list=$AddressList comment=AS200169 address=77.67.15.0/24} on-error {}
:do {add list=$AddressList comment=AS200169 address=78.154.114.0/24} on-error {}
