...
:do {add list=$AddressList comment=AS55081 address=103.155.60.0/24} on-error {}
...
:do {add list=$AddressList comment=AS55081 address=170.205.57.0/24} on-error {}
...
:do {add list=$AddressList comment=AS55081 address=209.177.79.0/24} on-error {}
:do {add list=$AddressList comment=AS55081 address=209.205.192.0/24} on-error {}
:do {add list=$AddressList comment=AS55081 address=209.205.194.0/23} on-error {}
:do {add list=$AddressList comment=AS55081 address=209.205.196.0/22} on-error {}
...
:do {add list=$AddressList comment=AS55081 address=23.191.200.0/24} on-error {}
