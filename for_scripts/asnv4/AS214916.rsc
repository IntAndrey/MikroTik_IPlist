...
:do {add list=$AddressList comment=AS214916 address=104.251.176.0/22} on-error {}
:do {add list=$AddressList comment=AS214916 address=107.148.6.0/24} on-error {}
:do {add list=$AddressList comment=AS214916 address=108.165.28.0/22} on-error {}
...
:do {add list=$AddressList comment=AS214916 address=50.114.187.0/24} on-error {}
