...
:do {add list=$AddressList comment=AS18101 address=202.138.103.0/24} on-error {}
...
:do {add list=$AddressList comment=AS18101 address=202.138.96.0/23} on-error {}
:do {add list=$AddressList comment=AS18101 address=202.138.98.0/24} on-error {}
