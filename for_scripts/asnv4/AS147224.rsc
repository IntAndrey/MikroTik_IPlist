...
:do {add list=$AddressList comment=AS147224 address=103.178.1.0/24} on-error {}
:do {add list=$AddressList comment=AS147224 address=103.207.181.0/24} on-error {}
:do {add list=$AddressList comment=AS147224 address=138.252.204.0/24} on-error {}
:do {add list=$AddressList comment=AS147224 address=157.15.98.0/23} on-error {}
:do {add list=$AddressList comment=AS147224 address=202.47.174.0/24} on-error {}
:do {add list=$AddressList comment=AS147224 address=27.0.144.0/24} on-error {}
