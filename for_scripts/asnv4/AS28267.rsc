...
:do {add list=$AddressList comment=AS28267 address=170.245.129.0/24} on-error {}
...
:do {add list=$AddressList comment=AS28267 address=45.182.121.0/24} on-error {}
:do {add list=$AddressList comment=AS28267 address=45.182.122.0/23} on-error {}
