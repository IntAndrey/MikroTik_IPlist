...
:do {add list=$AddressList comment=AS265696 address=131.196.210.0/23} on-error {}
:do {add list=$AddressList comment=AS265696 address=131.196.212.0/22} on-error {}
...
:do {add list=$AddressList comment=AS265696 address=45.5.174.0/23} on-error {}
