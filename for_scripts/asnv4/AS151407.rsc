...
:do {add list=$AddressList comment=AS151407 address=141.98.1.0/24} on-error {}
...
:do {add list=$AddressList comment=AS151407 address=2.27.148.0/24} on-error {}
:do {add list=$AddressList comment=AS151407 address=2.27.99.0/24} on-error {}
...
:do {add list=$AddressList comment=AS151407 address=82.47.32.0/22} on-error {}
