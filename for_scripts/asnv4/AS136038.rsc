...
:do {add list=$AddressList comment=AS136038 address=193.239.150.0/24} on-error {}
:do {add list=$AddressList comment=AS136038 address=193.239.154.0/23} on-error {}
:do {add list=$AddressList comment=AS136038 address=194.126.202.0/24} on-error {}
:do {add list=$AddressList comment=AS136038 address=199.212.57.0/24} on-error {}
:do {add list=$AddressList comment=AS136038 address=2.59.152.0/24} on-error {}
:do {add list=$AddressList comment=AS136038 address=2.59.154.0/23} on-error {}
:do {add list=$AddressList comment=AS136038 address=45.142.152.0/24} on-error {}
:do {add list=$AddressList comment=AS136038 address=45.142.155.0/24} on-error {}
:do {add list=$AddressList comment=AS136038 address=45.91.225.0/24} on-error {}
:do {add list=$AddressList comment=AS136038 address=45.91.226.0/24} on-error {}
