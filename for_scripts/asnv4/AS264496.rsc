...
:do {add list=$AddressList comment=AS264496 address=177.55.65.0/24} on-error {}
:do {add list=$AddressList comment=AS264496 address=177.55.66.0/23} on-error {}
:do {add list=$AddressList comment=AS264496 address=177.55.68.0/24} on-error {}
:do {add list=$AddressList comment=AS264496 address=177.55.70.0/23} on-error {}
