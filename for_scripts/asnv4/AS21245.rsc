...
:do {add list=$AddressList comment=AS21245 address=82.25.140.0/24} on-error {}
:do {add list=$AddressList comment=AS21245 address=82.26.124.0/24} on-error {}
:do {add list=$AddressList comment=AS21245 address=82.38.196.0/23} on-error {}
:do {add list=$AddressList comment=AS21245 address=91.208.32.0/24} on-error {}
