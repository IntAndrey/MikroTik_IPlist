...
:do {add list=$AddressList comment=AS38750 address=103.213.116.0/24} on-error {}
:do {add list=$AddressList comment=AS38750 address=103.213.118.0/23} on-error {}
...
:do {add list=$AddressList comment=AS38750 address=121.50.36.0/22} on-error {}
