...
:do {add list=$AddressList comment=AS6279 address=65.72.1.0/24} on-error {}
:do {add list=$AddressList comment=AS6279 address=65.72.192.0/24} on-error {}
:do {add list=$AddressList comment=AS6279 address=65.72.2.0/23} on-error {}
:do {add list=$AddressList comment=AS6279 address=65.72.4.0/23} on-error {}
