...
:do {add list=$AddressList comment=AS44239 address=68.70.199.0/24} on-error {}
:do {add list=$AddressList comment=AS44239 address=68.70.201.0/24} on-error {}
:do {add list=$AddressList comment=AS44239 address=68.70.202.0/23} on-error {}
