...
:do {add list=$AddressList comment=AS17483 address=49.156.128.0/21} on-error {}
:do {add list=$AddressList comment=AS17483 address=49.156.136.0/22} on-error {}
:do {add list=$AddressList comment=AS17483 address=49.156.140.0/23} on-error {}
:do {add list=$AddressList comment=AS17483 address=49.156.142.0/24} on-error {}
