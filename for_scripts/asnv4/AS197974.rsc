...
:do {add list=$AddressList comment=AS197974 address=31.56.184.0/23} on-error {}
...
:do {add list=$AddressList comment=AS197974 address=31.76.38.0/23} on-error {}
:do {add list=$AddressList comment=AS197974 address=31.76.91.0/24} on-error {}
:do {add list=$AddressList comment=AS197974 address=31.77.152.0/22} on-error {}
:do {add list=$AddressList comment=AS197974 address=31.77.201.0/24} on-error {}
