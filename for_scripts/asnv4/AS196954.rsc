...
:do {add list=$AddressList comment=AS196954 address=130.255.120.0/21} on-error {}
:do {add list=$AddressList comment=AS196954 address=145.63.192.0/20} on-error {}
...
:do {add list=$AddressList comment=AS196954 address=85.208.238.0/23} on-error {}
:do {add list=$AddressList comment=AS196954 address=91.194.132.0/23} on-error {}
:do {add list=$AddressList comment=AS196954 address=91.239.92.0/23} on-error {}
