...
:do {add list=$AddressList comment=AS147185 address=103.105.226.0/24} on-error {}
:do {add list=$AddressList comment=AS147185 address=103.130.108.0/23} on-error {}
:do {add list=$AddressList comment=AS147185 address=103.156.18.0/23} on-error {}
:do {add list=$AddressList comment=AS147185 address=103.174.52.0/23} on-error {}
:do {add list=$AddressList comment=AS147185 address=103.189.216.0/24} on-error {}
...
:do {add list=$AddressList comment=AS147185 address=103.42.74.0/24} on-error {}
:do {add list=$AddressList comment=AS147185 address=113.30.144.0/22} on-error {}
:do {add list=$AddressList comment=AS147185 address=144.79.100.0/23} on-error {}
