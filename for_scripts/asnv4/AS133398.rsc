...
:do {add list=$AddressList comment=AS133398 address=196.197.29.0/24} on-error {}
:do {add list=$AddressList comment=AS133398 address=196.198.29.0/24} on-error {}
:do {add list=$AddressList comment=AS133398 address=196.199.29.0/24} on-error {}
