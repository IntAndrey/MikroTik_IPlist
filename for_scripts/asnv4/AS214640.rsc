...
:do {add list=$AddressList comment=AS214640 address=136.148.208.0/20} on-error {}
:do {add list=$AddressList comment=AS214640 address=143.14.22.0/24} on-error {}
:do {add list=$AddressList comment=AS214640 address=143.14.50.0/24} on-error {}
...
:do {add list=$AddressList comment=AS214640 address=207.2.120.0/24} on-error {}
...
:do {add list=$AddressList comment=AS214640 address=64.112.124.0/22} on-error {}
