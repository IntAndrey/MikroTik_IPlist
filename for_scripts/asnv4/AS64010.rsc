...
:do {add list=$AddressList comment=AS64010 address=154.22.142.0/23} on-error {}
:do {add list=$AddressList comment=AS64010 address=154.3.130.0/23} on-error {}
:do {add list=$AddressList comment=AS64010 address=154.9.202.0/23} on-error {}
