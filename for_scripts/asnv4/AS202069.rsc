...
:do {add list=$AddressList comment=AS202069 address=152.175.192.0/20} on-error {}
:do {add list=$AddressList comment=AS202069 address=152.175.20.0/22} on-error {}
:do {add list=$AddressList comment=AS202069 address=152.175.215.0/24} on-error {}
:do {add list=$AddressList comment=AS202069 address=152.175.216.0/21} on-error {}
:do {add list=$AddressList comment=AS202069 address=152.175.224.0/19} on-error {}
...
:do {add list=$AddressList comment=AS202069 address=152.175.67.0/24} on-error {}
