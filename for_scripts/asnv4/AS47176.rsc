...
:do {add list=$AddressList comment=AS47176 address=185.213.58.0/24} on-error {}
:do {add list=$AddressList comment=AS47176 address=185.238.12.0/24} on-error {}
:do {add list=$AddressList comment=AS47176 address=185.238.14.0/23} on-error {}
