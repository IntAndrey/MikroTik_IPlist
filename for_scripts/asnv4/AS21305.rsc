...
:do {add list=$AddressList comment=AS21305 address=95.128.64.0/23} on-error {}
:do {add list=$AddressList comment=AS21305 address=95.128.67.0/24} on-error {}
:do {add list=$AddressList comment=AS21305 address=95.128.69.0/24} on-error {}
