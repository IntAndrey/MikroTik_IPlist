...
:do {add list=$AddressList comment=AS215731 address=103.240.216.0/23} on-error {}
:do {add list=$AddressList comment=AS215731 address=103.240.218.0/24} on-error {}
:do {add list=$AddressList comment=AS215731 address=103.243.36.0/22} on-error {}
...
:do {add list=$AddressList comment=AS215731 address=167.179.212.0/22} on-error {}
:do {add list=$AddressList comment=AS215731 address=185.100.40.0/22} on-error {}
:do {add list=$AddressList comment=AS215731 address=195.128.4.0/23} on-error {}
:do {add list=$AddressList comment=AS215731 address=195.128.6.0/24} on-error {}
:do {add list=$AddressList comment=AS215731 address=195.142.156.0/22} on-error {}
:do {add list=$AddressList comment=AS215731 address=202.140.133.0/24} on-error {}
:do {add list=$AddressList comment=AS215731 address=43.228.198.0/23} on-error {}
