...
:do {add list=$AddressList comment=AS207728 address=103.65.230.0/23} on-error {}
:do {add list=$AddressList comment=AS207728 address=104.192.42.0/24} on-error {}
:do {add list=$AddressList comment=AS207728 address=138.226.220.0/22} on-error {}
:do {add list=$AddressList comment=AS207728 address=148.227.170.0/24} on-error {}
...
:do {add list=$AddressList comment=AS207728 address=185.204.54.0/23} on-error {}
...
:do {add list=$AddressList comment=AS207728 address=62.171.228.0/23} on-error {}
:do {add list=$AddressList comment=AS207728 address=62.171.230.0/24} on-error {}
:do {add list=$AddressList comment=AS207728 address=62.204.42.0/24} on-error {}
:do {add list=$AddressList comment=AS207728 address=85.136.112.0/23} on-error {}
:do {add list=$AddressList comment=AS207728 address=85.136.114.0/24} on-error {}
