...
:do {add list=$AddressList comment=AS328880 address=197.10.64.0/18} on-error {}
...
:do {add list=$AddressList comment=AS328880 address=197.11.152.0/22} on-error {}
:do {add list=$AddressList comment=AS328880 address=197.11.158.0/23} on-error {}
