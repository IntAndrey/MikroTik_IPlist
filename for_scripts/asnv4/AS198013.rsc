...
:do {add list=$AddressList comment=AS198013 address=94.185.104.0/23} on-error {}
:do {add list=$AddressList comment=AS198013 address=94.185.107.0/24} on-error {}
...
:do {add list=$AddressList comment=AS198013 address=94.185.114.0/24} on-error {}
