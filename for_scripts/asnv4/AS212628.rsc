...
:do {add list=$AddressList comment=AS212628 address=154.16.243.0/24} on-error {}
...
:do {add list=$AddressList comment=AS212628 address=66.51.64.0/23} on-error {}
:do {add list=$AddressList comment=AS212628 address=66.51.66.0/24} on-error {}
