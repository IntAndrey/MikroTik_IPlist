...
:do {add list=$AddressList comment=AS399122 address=161.115.250.0/24} on-error {}
...
:do {add list=$AddressList comment=AS399122 address=64.130.15.0/24} on-error {}
:do {add list=$AddressList comment=AS399122 address=64.130.2.0/24} on-error {}
:do {add list=$AddressList comment=AS399122 address=64.130.6.0/23} on-error {}
:do {add list=$AddressList comment=AS399122 address=64.130.8.0/24} on-error {}
