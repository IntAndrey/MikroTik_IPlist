...
:do {add list=$AddressList comment=AS203156 address=178.83.36.0/24} on-error {}
:do {add list=$AddressList comment=AS203156 address=178.83.56.0/24} on-error {}
:do {add list=$AddressList comment=AS203156 address=185.115.162.0/24} on-error {}
...
:do {add list=$AddressList comment=AS203156 address=82.26.71.0/24} on-error {}
