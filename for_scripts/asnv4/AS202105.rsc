...
:do {add list=$AddressList comment=AS202105 address=185.203.108.0/23} on-error {}
:do {add list=$AddressList comment=AS202105 address=185.203.110.0/24} on-error {}
...
:do {add list=$AddressList comment=AS202105 address=185.206.30.0/24} on-error {}
