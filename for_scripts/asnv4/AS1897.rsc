...
:do {add list=$AddressList comment=AS1897 address=193.126.0.0/18} on-error {}
:do {add list=$AddressList comment=AS1897 address=193.126.112.0/23} on-error {}
:do {add list=$AddressList comment=AS1897 address=193.126.114.0/24} on-error {}
:do {add list=$AddressList comment=AS1897 address=193.126.116.0/22} on-error {}
:do {add list=$AddressList comment=AS1897 address=193.126.120.0/21} on-error {}
:do {add list=$AddressList comment=AS1897 address=193.126.128.0/17} on-error {}
:do {add list=$AddressList comment=AS1897 address=193.126.64.0/19} on-error {}
:do {add list=$AddressList comment=AS1897 address=193.126.96.0/20} on-error {}
:do {add list=$AddressList comment=AS1897 address=194.79.64.0/19} on-error {}
:do {add list=$AddressList comment=AS1897 address=195.23.0.0/16} on-error {}
