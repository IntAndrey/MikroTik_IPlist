...
:do {add list=$AddressList comment=AS30881 address=94.136.192.0/20} on-error {}
:do {add list=$AddressList comment=AS30881 address=94.136.208.0/23} on-error {}
:do {add list=$AddressList comment=AS30881 address=94.136.212.0/22} on-error {}
:do {add list=$AddressList comment=AS30881 address=94.136.216.0/21} on-error {}
