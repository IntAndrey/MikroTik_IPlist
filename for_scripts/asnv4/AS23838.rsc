...
:do {add list=$AddressList comment=AS23838 address=103.198.104.0/23} on-error {}
...
:do {add list=$AddressList comment=AS23838 address=202.14.100.0/24} on-error {}
:do {add list=$AddressList comment=AS23838 address=202.36.36.0/22} on-error {}
