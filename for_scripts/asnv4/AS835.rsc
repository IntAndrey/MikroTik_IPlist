...
:do {add list=$AddressList comment=AS835 address=153.76.0.0/24} on-error {}
:do {add list=$AddressList comment=AS835 address=153.76.5.0/24} on-error {}
...
:do {add list=$AddressList comment=AS835 address=23.246.184.0/24} on-error {}
