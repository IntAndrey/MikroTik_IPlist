...
:do {add list=$AddressList comment=AS41717 address=103.99.77.0/24} on-error {}
...
:do {add list=$AddressList comment=AS41717 address=2.58.244.0/22} on-error {}
:do {add list=$AddressList comment=AS41717 address=2.58.248.0/24} on-error {}
...
:do {add list=$AddressList comment=AS41717 address=5.183.120.0/23} on-error {}
:do {add list=$AddressList comment=AS41717 address=5.183.122.0/24} on-error {}
