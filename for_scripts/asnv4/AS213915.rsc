...
:do {add list=$AddressList comment=AS213915 address=151.242.160.0/23} on-error {}
:do {add list=$AddressList comment=AS213915 address=151.242.162.0/24} on-error {}
:do {add list=$AddressList comment=AS213915 address=217.60.12.0/23} on-error {}
:do {add list=$AddressList comment=AS213915 address=217.60.16.0/21} on-error {}
:do {add list=$AddressList comment=AS213915 address=217.60.251.0/24} on-error {}
:do {add list=$AddressList comment=AS213915 address=217.60.68.0/23} on-error {}
:do {add list=$AddressList comment=AS213915 address=217.60.71.0/24} on-error {}
...
:do {add list=$AddressList comment=AS213915 address=94.183.241.0/24} on-error {}
:do {add list=$AddressList comment=AS213915 address=94.183.255.0/24} on-error {}
