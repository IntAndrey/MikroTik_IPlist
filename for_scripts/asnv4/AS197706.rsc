...
:do {add list=$AddressList comment=AS197706 address=195.146.16.0/24} on-error {}
:do {add list=$AddressList comment=AS197706 address=195.146.18.0/24} on-error {}
:do {add list=$AddressList comment=AS197706 address=195.146.20.0/24} on-error {}
:do {add list=$AddressList comment=AS197706 address=195.146.22.0/24} on-error {}
:do {add list=$AddressList comment=AS197706 address=195.146.24.0/24} on-error {}
:do {add list=$AddressList comment=AS197706 address=195.146.26.0/24} on-error {}
:do {add list=$AddressList comment=AS197706 address=195.146.28.0/24} on-error {}
