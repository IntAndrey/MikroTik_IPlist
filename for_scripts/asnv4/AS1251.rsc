...
:do {add list=$AddressList comment=AS1251 address=200.136.182.0/23} on-error {}
:do {add list=$AddressList comment=AS1251 address=200.136.184.0/22} on-error {}
:do {add list=$AddressList comment=AS1251 address=200.136.32.0/20} on-error {}
:do {add list=$AddressList comment=AS1251 address=200.136.48.0/24} on-error {}
:do {add list=$AddressList comment=AS1251 address=200.136.50.0/23} on-error {}
...
:do {add list=$AddressList comment=AS1251 address=200.144.32.0/20} on-error {}
:do {add list=$AddressList comment=AS1251 address=200.144.64.0/21} on-error {}
:do {add list=$AddressList comment=AS1251 address=200.144.78.0/23} on-error {}
:do {add list=$AddressList comment=AS1251 address=200.144.81.0/24} on-error {}
:do {add list=$AddressList comment=AS1251 address=200.144.82.0/23} on-error {}
:do {add list=$AddressList comment=AS1251 address=200.144.84.0/22} on-error {}
:do {add list=$AddressList comment=AS1251 address=200.144.88.0/23} on-error {}
:do {add list=$AddressList comment=AS1251 address=200.144.90.0/24} on-error {}
:do {add list=$AddressList comment=AS1251 address=200.144.95.0/24} on-error {}
:do {add list=$AddressList comment=AS1251 address=200.18.110.0/23} on-error {}
:do {add list=$AddressList comment=AS1251 address=200.18.240.0/20} on-error {}
:do {add list=$AddressList comment=AS1251 address=200.18.48.0/22} on-error {}
:do {add list=$AddressList comment=AS1251 address=200.18.52.0/24} on-error {}
:do {add list=$AddressList comment=AS1251 address=200.18.54.0/23} on-error {}
