...
:do {add list=$AddressList comment=AS64139 address=167.249.28.0/23} on-error {}
:do {add list=$AddressList comment=AS64139 address=207.248.0.0/22} on-error {}
:do {add list=$AddressList comment=AS64139 address=38.211.127.0/24} on-error {}
:do {add list=$AddressList comment=AS64139 address=38.211.147.0/24} on-error {}
:do {add list=$AddressList comment=AS64139 address=45.170.102.0/23} on-error {}
