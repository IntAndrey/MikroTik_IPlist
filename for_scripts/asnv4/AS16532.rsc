...
:do {add list=$AddressList comment=AS16532 address=66.158.144.0/21} on-error {}
:do {add list=$AddressList comment=AS16532 address=72.10.140.0/24} on-error {}
:do {add list=$AddressList comment=AS16532 address=72.10.144.0/23} on-error {}
:do {add list=$AddressList comment=AS16532 address=72.10.147.0/24} on-error {}
:do {add list=$AddressList comment=AS16532 address=72.10.148.0/23} on-error {}
:do {add list=$AddressList comment=AS16532 address=72.10.150.0/24} on-error {}
