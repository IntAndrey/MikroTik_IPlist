...
:do {add list=$AddressList comment=AS199412 address=163.5.173.0/24} on-error {}
...
:do {add list=$AddressList comment=AS199412 address=46.20.110.0/24} on-error {}
...
:do {add list=$AddressList comment=AS199412 address=89.125.12.0/24} on-error {}
