...
:do {add list=$AddressList comment=AS147034 address=205.196.152.0/24} on-error {}
:do {add list=$AddressList comment=AS147034 address=205.196.154.0/24} on-error {}
:do {add list=$AddressList comment=AS147034 address=205.196.157.0/24} on-error {}
