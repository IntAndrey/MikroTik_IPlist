...
:do {add list=$AddressList comment=AS395784 address=158.224.24.0/23} on-error {}
:do {add list=$AddressList comment=AS395784 address=158.224.38.0/24} on-error {}
:do {add list=$AddressList comment=AS395784 address=158.224.40.0/23} on-error {}
...
:do {add list=$AddressList comment=AS395784 address=158.224.8.0/23} on-error {}
