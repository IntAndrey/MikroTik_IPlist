...
:do {add list=$AddressList comment=AS262369 address=170.247.244.0/22} on-error {}
:do {add list=$AddressList comment=AS262369 address=170.254.184.0/22} on-error {}
:do {add list=$AddressList comment=AS262369 address=177.130.80.0/21} on-error {}
