...
:do {add list=$AddressList comment=AS197173 address=194.26.3.0/24} on-error {}
...
:do {add list=$AddressList comment=AS197173 address=64.188.19.0/24} on-error {}
:do {add list=$AddressList comment=AS197173 address=64.204.115.0/24} on-error {}
:do {add list=$AddressList comment=AS197173 address=65.87.27.0/24} on-error {}
:do {add list=$AddressList comment=AS197173 address=66.92.37.0/24} on-error {}
:do {add list=$AddressList comment=AS197173 address=69.33.192.0/24} on-error {}
:do {add list=$AddressList comment=AS197173 address=78.108.124.0/24} on-error {}
:do {add list=$AddressList comment=AS197173 address=82.24.72.0/24} on-error {}
