...
:do {add list=$AddressList comment=AS58002 address=37.208.64.0/21} on-error {}
:do {add list=$AddressList comment=AS58002 address=37.208.72.0/22} on-error {}
:do {add list=$AddressList comment=AS58002 address=37.208.76.0/24} on-error {}
...
:do {add list=$AddressList comment=AS58002 address=92.241.12.0/24} on-error {}
