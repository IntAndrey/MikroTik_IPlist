...
:do {add list=$AddressList comment=AS59588 address=154.43.178.0/23} on-error {}
:do {add list=$AddressList comment=AS59588 address=185.112.190.0/24} on-error {}
...
:do {add list=$AddressList comment=AS59588 address=198.160.164.0/22} on-error {}
...
:do {add list=$AddressList comment=AS59588 address=204.157.181.0/24} on-error {}
:do {add list=$AddressList comment=AS59588 address=45.153.116.0/22} on-error {}
:do {add list=$AddressList comment=AS59588 address=5.252.132.0/24} on-error {}
:do {add list=$AddressList comment=AS59588 address=5.252.134.0/23} on-error {}
