...
:do {add list=$AddressList comment=AS202660 address=87.192.252.0/23} on-error {}
:do {add list=$AddressList comment=AS202660 address=89.126.208.0/21} on-error {}
:do {add list=$AddressList comment=AS202660 address=89.126.220.0/22} on-error {}
