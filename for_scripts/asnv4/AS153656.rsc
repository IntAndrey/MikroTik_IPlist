...
:do {add list=$AddressList comment=AS153656 address=163.8.216.0/24} on-error {}
:do {add list=$AddressList comment=AS153656 address=166.88.26.0/24} on-error {}
:do {add list=$AddressList comment=AS153656 address=168.222.65.0/24} on-error {}
...
:do {add list=$AddressList comment=AS153656 address=82.41.66.0/24} on-error {}
