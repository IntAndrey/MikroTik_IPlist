...
:do {add list=$AddressList comment=AS212087 address=149.71.40.0/21} on-error {}
:do {add list=$AddressList comment=AS212087 address=149.71.96.0/21} on-error {}
:do {add list=$AddressList comment=AS212087 address=149.86.232.0/21} on-error {}
...
:do {add list=$AddressList comment=AS212087 address=154.62.88.0/21} on-error {}
...
:do {add list=$AddressList comment=AS212087 address=38.58.40.0/21} on-error {}
