...
:do {add list=$AddressList comment=AS17139 address=205.134.224.0/21} on-error {}
:do {add list=$AddressList comment=AS17139 address=208.103.154.0/24} on-error {}
:do {add list=$AddressList comment=AS17139 address=208.51.60.0/22} on-error {}
...
:do {add list=$AddressList comment=AS17139 address=74.124.199.0/24} on-error {}
