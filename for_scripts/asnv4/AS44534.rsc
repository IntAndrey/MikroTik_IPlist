...
:do {add list=$AddressList comment=AS44534 address=93.158.168.0/23} on-error {}
:do {add list=$AddressList comment=AS44534 address=93.158.170.0/24} on-error {}
:do {add list=$AddressList comment=AS44534 address=93.158.184.0/21} on-error {}
