...
:do {add list=$AddressList comment=AS12213 address=108.186.178.0/24} on-error {}
...
:do {add list=$AddressList comment=AS12213 address=149.137.248.0/23} on-error {}
:do {add list=$AddressList comment=AS12213 address=149.137.250.0/24} on-error {}
...
:do {add list=$AddressList comment=AS12213 address=24.170.128.0/21} on-error {}
:do {add list=$AddressList comment=AS12213 address=24.170.140.0/22} on-error {}
:do {add list=$AddressList comment=AS12213 address=24.170.144.0/21} on-error {}
:do {add list=$AddressList comment=AS12213 address=24.170.154.0/23} on-error {}
