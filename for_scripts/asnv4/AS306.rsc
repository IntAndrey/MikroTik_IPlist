...
:do {add list=$AddressList comment=AS306 address=132.80.0.0/15} on-error {}
:do {add list=$AddressList comment=AS306 address=132.83.0.0/16} on-error {}
:do {add list=$AddressList comment=AS306 address=132.84.0.0/14} on-error {}
:do {add list=$AddressList comment=AS306 address=132.88.0.0/13} on-error {}
