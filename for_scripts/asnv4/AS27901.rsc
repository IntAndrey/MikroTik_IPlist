...
:do {add list=$AddressList comment=AS27901 address=179.60.64.0/20} on-error {}
:do {add list=$AddressList comment=AS27901 address=179.60.91.0/24} on-error {}
...
:do {add list=$AddressList comment=AS27901 address=190.5.32.0/20} on-error {}
:do {add list=$AddressList comment=AS27901 address=200.73.120.0/21} on-error {}
:do {add list=$AddressList comment=AS27901 address=207.248.192.0/19} on-error {}
