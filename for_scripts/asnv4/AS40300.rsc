...
:do {add list=$AddressList comment=AS40300 address=161.108.122.0/24} on-error {}
:do {add list=$AddressList comment=AS40300 address=162.218.108.0/22} on-error {}
...
:do {add list=$AddressList comment=AS40300 address=208.111.56.0/21} on-error {}
