...
:do {add list=$AddressList comment=AS22297 address=104.171.204.0/22} on-error {}
:do {add list=$AddressList comment=AS22297 address=164.153.165.0/24} on-error {}
:do {add list=$AddressList comment=AS22297 address=173.239.19.0/24} on-error {}
:do {add list=$AddressList comment=AS22297 address=173.239.20.0/24} on-error {}
...
:do {add list=$AddressList comment=AS22297 address=199.246.24.0/24} on-error {}
...
:do {add list=$AddressList comment=AS22297 address=74.206.248.0/23} on-error {}
:do {add list=$AddressList comment=AS22297 address=74.206.254.0/23} on-error {}
