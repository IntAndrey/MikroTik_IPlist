...
:do {add list=$AddressList comment=AS35567 address=91.191.24.0/23} on-error {}
:do {add list=$AddressList comment=AS35567 address=91.191.27.0/24} on-error {}
:do {add list=$AddressList comment=AS35567 address=91.191.28.0/22} on-error {}
