...
:do {add list=$AddressList comment=AS7040 address=199.66.88.0/24} on-error {}
:do {add list=$AddressList comment=AS7040 address=199.66.90.0/24} on-error {}
:do {add list=$AddressList comment=AS7040 address=199.66.92.0/23} on-error {}
:do {add list=$AddressList comment=AS7040 address=208.81.204.0/23} on-error {}
