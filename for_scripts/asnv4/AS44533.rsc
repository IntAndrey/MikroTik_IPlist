...
:do {add list=$AddressList comment=AS44533 address=185.232.47.0/24} on-error {}
...
:do {add list=$AddressList comment=AS44533 address=212.18.96.0/24} on-error {}
...
:do {add list=$AddressList comment=AS44533 address=91.213.117.0/24} on-error {}
