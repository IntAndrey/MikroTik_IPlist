...
:do {add list=$AddressList comment=AS174 address=38.132.212.0/23} on-error {}
:do {add list=$AddressList comment=AS174 address=38.132.214.0/24} on-error {}
...
:do {add list=$AddressList comment=AS174 address=38.133.188.0/24} on-error {}
...
:do {add list=$AddressList comment=AS174 address=38.135.178.0/24} on-error {}
