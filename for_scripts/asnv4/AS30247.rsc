...
:do {add list=$AddressList comment=AS30247 address=38.92.4.0/24} on-error {}
:do {add list=$AddressList comment=AS30247 address=38.92.5.0/25} on-error {}
:do {add list=$AddressList comment=AS30247 address=38.92.5.128/26} on-error {}
:do {add list=$AddressList comment=AS30247 address=38.92.5.192/27} on-error {}
:do {add list=$AddressList comment=AS30247 address=38.92.5.224/28} on-error {}
:do {add list=$AddressList comment=AS30247 address=38.92.5.240/29} on-error {}
:do {add list=$AddressList comment=AS30247 address=38.92.5.248/31} on-error {}
:do {add list=$AddressList comment=AS30247 address=38.92.5.250/32} on-error {}
:do {add list=$AddressList comment=AS30247 address=38.92.5.252/30} on-error {}
:do {add list=$AddressList comment=AS30247 address=38.92.6.0/23} on-error {}
