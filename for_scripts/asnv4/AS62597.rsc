...
:do {add list=$AddressList comment=AS62597 address=163.114.212.0/24} on-error {}
:do {add list=$AddressList comment=AS62597 address=163.114.214.0/23} on-error {}
...
:do {add list=$AddressList comment=AS62597 address=163.114.234.0/24} on-error {}
