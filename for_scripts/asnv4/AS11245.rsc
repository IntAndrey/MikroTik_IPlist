...
:do {add list=$AddressList comment=AS11245 address=167.232.238.0/24} on-error {}
...
:do {add list=$AddressList comment=AS11245 address=167.232.246.0/24} on-error {}
:do {add list=$AddressList comment=AS11245 address=167.232.248.0/22} on-error {}
