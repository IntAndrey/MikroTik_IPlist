...
:do {add list=$AddressList comment=AS18862 address=152.145.168.0/24} on-error {}
:do {add list=$AddressList comment=AS18862 address=152.145.172.0/24} on-error {}
...
:do {add list=$AddressList comment=AS18862 address=74.116.83.0/24} on-error {}
