...
:do {add list=$AddressList comment=AS17975 address=203.169.32.0/22} on-error {}
...
:do {add list=$AddressList comment=AS17975 address=221.120.184.0/22} on-error {}
:do {add list=$AddressList comment=AS17975 address=221.120.189.0/24} on-error {}
:do {add list=$AddressList comment=AS17975 address=221.120.190.0/23} on-error {}
