...
:do {add list=$AddressList comment=AS58232 address=217.144.156.0/24} on-error {}
:do {add list=$AddressList comment=AS58232 address=45.135.195.0/24} on-error {}
:do {add list=$AddressList comment=AS58232 address=79.172.204.0/24} on-error {}
...
:do {add list=$AddressList comment=AS58232 address=94.184.37.0/24} on-error {}
