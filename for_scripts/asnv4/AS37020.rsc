...
:do {add list=$AddressList comment=AS37020 address=196.61.74.0/23} on-error {}
...
:do {add list=$AddressList comment=AS37020 address=41.243.27.0/24} on-error {}
...
:do {add list=$AddressList comment=AS37020 address=41.243.50.0/24} on-error {}
:do {add list=$AddressList comment=AS37020 address=41.243.52.0/24} on-error {}
:do {add list=$AddressList comment=AS37020 address=41.243.54.0/23} on-error {}
:do {add list=$AddressList comment=AS37020 address=41.243.56.0/23} on-error {}
:do {add list=$AddressList comment=AS37020 address=41.243.60.0/23} on-error {}
:do {add list=$AddressList comment=AS37020 address=41.243.62.0/24} on-error {}
:do {add list=$AddressList comment=AS37020 address=41.243.73.0/24} on-error {}
:do {add list=$AddressList comment=AS37020 address=41.243.75.0/24} on-error {}
:do {add list=$AddressList comment=AS37020 address=41.243.76.0/24} on-error {}
:do {add list=$AddressList comment=AS37020 address=41.243.8.0/21} on-error {}
:do {add list=$AddressList comment=AS37020 address=41.243.80.0/24} on-error {}
