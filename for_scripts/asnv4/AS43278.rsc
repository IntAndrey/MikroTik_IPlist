...
:do {add list=$AddressList comment=AS43278 address=189.74.109.0/24} on-error {}
:do {add list=$AddressList comment=AS43278 address=189.74.110.0/23} on-error {}
:do {add list=$AddressList comment=AS43278 address=201.50.114.0/24} on-error {}
:do {add list=$AddressList comment=AS43278 address=212.46.36.0/24} on-error {}
:do {add list=$AddressList comment=AS43278 address=213.109.97.0/24} on-error {}
