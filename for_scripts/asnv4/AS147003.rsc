...
:do {add list=$AddressList comment=AS147003 address=147.90.66.0/23} on-error {}
...
:do {add list=$AddressList comment=AS147003 address=168.222.36.0/23} on-error {}
:do {add list=$AddressList comment=AS147003 address=185.11.142.0/23} on-error {}
:do {add list=$AddressList comment=AS147003 address=191.96.29.0/24} on-error {}
:do {add list=$AddressList comment=AS147003 address=2.27.128.0/23} on-error {}
:do {add list=$AddressList comment=AS147003 address=206.206.105.0/24} on-error {}
...
:do {add list=$AddressList comment=AS147003 address=213.110.70.0/23} on-error {}
...
:do {add list=$AddressList comment=AS147003 address=46.34.18.0/23} on-error {}
:do {add list=$AddressList comment=AS147003 address=82.41.138.0/23} on-error {}
