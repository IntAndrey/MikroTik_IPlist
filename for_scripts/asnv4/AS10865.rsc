...
:do {add list=$AddressList comment=AS10865 address=66.129.128.0/23} on-error {}
:do {add list=$AddressList comment=AS10865 address=66.129.131.0/24} on-error {}
:do {add list=$AddressList comment=AS10865 address=66.129.133.0/24} on-error {}
:do {add list=$AddressList comment=AS10865 address=66.129.136.0/24} on-error {}
...
:do {add list=$AddressList comment=AS10865 address=66.129.157.0/24} on-error {}
:do {add list=$AddressList comment=AS10865 address=66.129.158.0/24} on-error {}
