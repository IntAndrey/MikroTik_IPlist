...
:do {add list=$AddressList comment=AS16740 address=64.255.26.0/24} on-error {}
:do {add list=$AddressList comment=AS16740 address=64.255.47.0/24} on-error {}
:do {add list=$AddressList comment=AS16740 address=66.39.208.0/24} on-error {}
:do {add list=$AddressList comment=AS16740 address=69.60.2.0/24} on-error {}
