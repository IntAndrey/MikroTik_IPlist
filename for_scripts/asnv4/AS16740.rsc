...
:do {add list=$AddressList comment=AS16740 address=167.254.220.0/24} on-error {}
:do {add list=$AddressList comment=AS16740 address=167.254.222.0/23} on-error {}
...
:do {add list=$AddressList comment=AS16740 address=74.126.144.0/22} on-error {}
:do {add list=$AddressList comment=AS16740 address=74.188.248.0/22} on-error {}
:do {add list=$AddressList comment=AS16740 address=74.188.252.0/24} on-error {}
:do {add list=$AddressList comment=AS16740 address=74.188.254.0/23} on-error {}
