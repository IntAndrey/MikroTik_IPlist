...
:do {add list=$AddressList comment=AS35682 address=138.249.7.0/24} on-error {}
:do {add list=$AddressList comment=AS35682 address=170.168.6.0/24} on-error {}
:do {add list=$AddressList comment=AS35682 address=176.101.56.0/24} on-error {}
...
:do {add list=$AddressList comment=AS35682 address=189.74.96.0/21} on-error {}
...
:do {add list=$AddressList comment=AS35682 address=77.83.206.0/24} on-error {}
