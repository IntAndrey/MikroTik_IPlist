...
:do {add list=$AddressList comment=AS20149 address=98.97.200.0/22} on-error {}
:do {add list=$AddressList comment=AS20149 address=98.97.204.0/23} on-error {}
:do {add list=$AddressList comment=AS20149 address=98.97.207.0/24} on-error {}
:do {add list=$AddressList comment=AS20149 address=98.97.209.0/24} on-error {}
:do {add list=$AddressList comment=AS20149 address=98.97.210.0/23} on-error {}
