...
:do {add list=$AddressList comment=AS48475 address=37.208.77.0/24} on-error {}
:do {add list=$AddressList comment=AS48475 address=37.208.78.0/23} on-error {}
:do {add list=$AddressList comment=AS48475 address=46.231.168.0/21} on-error {}
:do {add list=$AddressList comment=AS48475 address=92.241.28.0/22} on-error {}
