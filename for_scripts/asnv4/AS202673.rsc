...
:do {add list=$AddressList comment=AS202673 address=155.117.147.0/24} on-error {}
:do {add list=$AddressList comment=AS202673 address=155.117.197.0/24} on-error {}
...
:do {add list=$AddressList comment=AS202673 address=178.253.224.0/24} on-error {}
:do {add list=$AddressList comment=AS202673 address=185.221.20.0/24} on-error {}
:do {add list=$AddressList comment=AS202673 address=185.245.63.0/24} on-error {}
