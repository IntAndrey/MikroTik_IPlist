...
:do {add list=$AddressList comment=AS14750 address=76.9.68.0/23} on-error {}
:do {add list=$AddressList comment=AS14750 address=76.9.70.0/26} on-error {}
:do {add list=$AddressList comment=AS14750 address=76.9.70.100/30} on-error {}
:do {add list=$AddressList comment=AS14750 address=76.9.70.104/29} on-error {}
:do {add list=$AddressList comment=AS14750 address=76.9.70.112/28} on-error {}
:do {add list=$AddressList comment=AS14750 address=76.9.70.128/25} on-error {}
:do {add list=$AddressList comment=AS14750 address=76.9.70.64/27} on-error {}
:do {add list=$AddressList comment=AS14750 address=76.9.70.97/32} on-error {}
:do {add list=$AddressList comment=AS14750 address=76.9.70.98/31} on-error {}
:do {add list=$AddressList comment=AS14750 address=76.9.71.0/24} on-error {}
