...
:do {add list=$AddressList comment=AS32738 address=208.70.56.0/24} on-error {}
:do {add list=$AddressList comment=AS32738 address=208.70.58.0/23} on-error {}
:do {add list=$AddressList comment=AS32738 address=208.70.60.0/22} on-error {}
