...
:do {add list=$AddressList comment=AS59796 address=160.79.120.0/23} on-error {}
:do {add list=$AddressList comment=AS59796 address=185.121.240.0/23} on-error {}
:do {add list=$AddressList comment=AS59796 address=185.121.242.0/24} on-error {}
:do {add list=$AddressList comment=AS59796 address=185.71.66.0/24} on-error {}
