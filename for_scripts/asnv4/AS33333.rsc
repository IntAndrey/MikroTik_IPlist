...
:do {add list=$AddressList comment=AS33333 address=67.220.86.0/24} on-error {}
...
:do {add list=$AddressList comment=AS33333 address=69.42.208.0/23} on-error {}
:do {add list=$AddressList comment=AS33333 address=69.42.210.0/24} on-error {}
...
:do {add list=$AddressList comment=AS33333 address=69.42.220.0/24} on-error {}
:do {add list=$AddressList comment=AS33333 address=69.42.223.0/24} on-error {}
