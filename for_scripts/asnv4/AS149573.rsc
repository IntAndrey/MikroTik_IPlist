...
:do {add list=$AddressList comment=AS149573 address=103.183.156.0/23} on-error {}
:do {add list=$AddressList comment=AS149573 address=140.99.208.0/24} on-error {}
:do {add list=$AddressList comment=AS149573 address=143.109.62.0/24} on-error {}
:do {add list=$AddressList comment=AS149573 address=144.225.27.0/24} on-error {}
