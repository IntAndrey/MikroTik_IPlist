...
:do {add list=$AddressList comment=AS30236 address=104.241.132.0/22} on-error {}
:do {add list=$AddressList comment=AS30236 address=104.241.136.0/22} on-error {}
...
:do {add list=$AddressList comment=AS30236 address=104.241.160.0/21} on-error {}
...
:do {add list=$AddressList comment=AS30236 address=198.1.248.0/21} on-error {}
