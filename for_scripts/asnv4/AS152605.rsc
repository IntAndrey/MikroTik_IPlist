...
:do {add list=$AddressList comment=AS152605 address=103.115.197.0/24} on-error {}
:do {add list=$AddressList comment=AS152605 address=103.115.198.0/23} on-error {}
:do {add list=$AddressList comment=AS152605 address=103.129.15.0/24} on-error {}
...
:do {add list=$AddressList comment=AS152605 address=192.232.42.0/23} on-error {}
:do {add list=$AddressList comment=AS152605 address=202.77.139.0/24} on-error {}
:do {add list=$AddressList comment=AS152605 address=38.100.220.0/22} on-error {}
:do {add list=$AddressList comment=AS152605 address=38.68.84.0/22} on-error {}
