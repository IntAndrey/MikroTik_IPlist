...
:do {add list=$AddressList comment=AS150593 address=103.137.48.0/23} on-error {}
:do {add list=$AddressList comment=AS150593 address=103.137.51.0/24} on-error {}
...
:do {add list=$AddressList comment=AS150593 address=202.66.186.0/23} on-error {}
