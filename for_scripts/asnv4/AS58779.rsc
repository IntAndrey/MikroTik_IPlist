...
:do {add list=$AddressList comment=AS58779 address=114.112.229.0/24} on-error {}
...
:do {add list=$AddressList comment=AS58779 address=114.113.254.0/24} on-error {}
:do {add list=$AddressList comment=AS58779 address=122.115.76.0/24} on-error {}
:do {add list=$AddressList comment=AS58779 address=122.14.149.0/24} on-error {}
:do {add list=$AddressList comment=AS58779 address=122.14.156.0/24} on-error {}
:do {add list=$AddressList comment=AS58779 address=203.191.24.0/23} on-error {}
...
:do {add list=$AddressList comment=AS58779 address=45.125.112.0/23} on-error {}
