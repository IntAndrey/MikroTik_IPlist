...
:do {add list=$AddressList comment=AS45582 address=103.52.36.0/23} on-error {}
:do {add list=$AddressList comment=AS45582 address=103.52.39.0/24} on-error {}
:do {add list=$AddressList comment=AS45582 address=119.235.48.0/21} on-error {}
:do {add list=$AddressList comment=AS45582 address=202.140.56.0/24} on-error {}
