...
:do {add list=$AddressList comment=AS26783 address=140.198.240.0/22} on-error {}
:do {add list=$AddressList comment=AS26783 address=140.198.244.0/23} on-error {}
:do {add list=$AddressList comment=AS26783 address=140.198.246.0/24} on-error {}
