...
:do {add list=$AddressList comment=AS26356 address=160.211.32.0/21} on-error {}
:do {add list=$AddressList comment=AS26356 address=160.211.45.0/24} on-error {}
:do {add list=$AddressList comment=AS26356 address=160.211.46.0/23} on-error {}
...
:do {add list=$AddressList comment=AS26356 address=160.211.68.0/22} on-error {}
:do {add list=$AddressList comment=AS26356 address=160.211.72.0/22} on-error {}
...
:do {add list=$AddressList comment=AS26356 address=91.106.220.0/22} on-error {}
