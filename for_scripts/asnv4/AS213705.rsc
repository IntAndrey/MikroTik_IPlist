...
:do {add list=$AddressList comment=AS213705 address=153.51.164.0/22} on-error {}
:do {add list=$AddressList comment=AS213705 address=153.51.168.0/22} on-error {}
...
:do {add list=$AddressList comment=AS213705 address=153.51.53.0/24} on-error {}
:do {add list=$AddressList comment=AS213705 address=153.51.54.0/23} on-error {}
