...
:do {add list=$AddressList comment=AS213705 address=131.123.1.0/24} on-error {}
...
:do {add list=$AddressList comment=AS213705 address=131.123.2.0/23} on-error {}
:do {add list=$AddressList comment=AS213705 address=131.123.21.0/24} on-error {}
:do {add list=$AddressList comment=AS213705 address=131.123.22.0/23} on-error {}
...
:do {add list=$AddressList comment=AS213705 address=131.123.31.0/24} on-error {}
:do {add list=$AddressList comment=AS213705 address=131.123.4.0/24} on-error {}
:do {add list=$AddressList comment=AS213705 address=131.123.6.0/23} on-error {}
:do {add list=$AddressList comment=AS213705 address=131.123.8.0/23} on-error {}
...
:do {add list=$AddressList comment=AS213705 address=85.204.176.0/22} on-error {}
:do {add list=$AddressList comment=AS213705 address=85.204.180.0/24} on-error {}
:do {add list=$AddressList comment=AS213705 address=85.204.182.0/23} on-error {}
:do {add list=$AddressList comment=AS213705 address=86.104.196.0/22} on-error {}
