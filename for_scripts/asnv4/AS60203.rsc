...
:do {add list=$AddressList comment=AS60203 address=5.45.160.0/21} on-error {}
:do {add list=$AddressList comment=AS60203 address=5.45.168.0/22} on-error {}
:do {add list=$AddressList comment=AS60203 address=5.45.174.0/23} on-error {}
