...
:do {add list=$AddressList comment=AS39600 address=155.229.208.0/24} on-error {}
:do {add list=$AddressList comment=AS39600 address=155.229.87.0/24} on-error {}
...
:do {add list=$AddressList comment=AS39600 address=45.195.159.0/24} on-error {}
...
:do {add list=$AddressList comment=AS39600 address=67.102.182.0/24} on-error {}
:do {add list=$AddressList comment=AS39600 address=74.114.117.0/24} on-error {}
:do {add list=$AddressList comment=AS39600 address=79.110.167.0/24} on-error {}
