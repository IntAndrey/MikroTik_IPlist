...
:do {add list=$AddressList comment=AS21803 address=209.140.0.0/24} on-error {}
...
:do {add list=$AddressList comment=AS21803 address=69.39.19.0/24} on-error {}
:do {add list=$AddressList comment=AS21803 address=69.39.21.0/24} on-error {}
:do {add list=$AddressList comment=AS21803 address=69.39.22.0/23} on-error {}
