...
:do {add list=$AddressList comment=AS34989 address=2.27.117.0/24} on-error {}
...
:do {add list=$AddressList comment=AS34989 address=31.56.239.0/24} on-error {}
:do {add list=$AddressList comment=AS34989 address=31.77.249.0/24} on-error {}
