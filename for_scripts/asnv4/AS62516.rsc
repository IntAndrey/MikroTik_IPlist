...
:do {add list=$AddressList comment=AS62516 address=38.128.164.0/25} on-error {}
:do {add list=$AddressList comment=AS62516 address=38.128.164.128/26} on-error {}
:do {add list=$AddressList comment=AS62516 address=38.128.164.192/31} on-error {}
:do {add list=$AddressList comment=AS62516 address=38.128.164.195/32} on-error {}
:do {add list=$AddressList comment=AS62516 address=38.128.164.196/30} on-error {}
:do {add list=$AddressList comment=AS62516 address=38.128.164.200/29} on-error {}
:do {add list=$AddressList comment=AS62516 address=38.128.164.208/28} on-error {}
:do {add list=$AddressList comment=AS62516 address=38.128.164.224/27} on-error {}
