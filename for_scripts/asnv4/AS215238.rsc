...
:do {add list=$AddressList comment=AS215238 address=212.134.162.0/24} on-error {}
...
:do {add list=$AddressList comment=AS215238 address=87.232.127.0/24} on-error {}
:do {add list=$AddressList comment=AS215238 address=87.76.130.0/24} on-error {}
:do {add list=$AddressList comment=AS215238 address=87.76.152.0/24} on-error {}
:do {add list=$AddressList comment=AS215238 address=87.76.161.0/24} on-error {}
:do {add list=$AddressList comment=AS215238 address=89.251.18.0/24} on-error {}
