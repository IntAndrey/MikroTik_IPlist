...
:do {add list=$AddressList comment=AS141342 address=116.90.114.0/24} on-error {}
:do {add list=$AddressList comment=AS141342 address=116.90.96.0/22} on-error {}
:do {add list=$AddressList comment=AS141342 address=122.129.65.0/24} on-error {}
:do {add list=$AddressList comment=AS141342 address=122.129.67.0/24} on-error {}
:do {add list=$AddressList comment=AS141342 address=122.129.70.0/23} on-error {}
:do {add list=$AddressList comment=AS141342 address=122.129.83.0/24} on-error {}
:do {add list=$AddressList comment=AS141342 address=122.129.87.0/24} on-error {}
...
:do {add list=$AddressList comment=AS141342 address=202.63.209.0/24} on-error {}
:do {add list=$AddressList comment=AS141342 address=202.63.210.0/24} on-error {}
