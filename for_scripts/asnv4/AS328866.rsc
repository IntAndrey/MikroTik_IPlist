...
:do {add list=$AddressList comment=AS328866 address=41.92.202.0/23} on-error {}
:do {add list=$AddressList comment=AS328866 address=41.92.208.0/24} on-error {}
:do {add list=$AddressList comment=AS328866 address=41.92.252.0/24} on-error {}
:do {add list=$AddressList comment=AS328866 address=41.92.254.0/23} on-error {}
