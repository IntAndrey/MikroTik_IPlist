...
:do {add list=$AddressList comment=AS63420 address=148.163.208.0/24} on-error {}
...
:do {add list=$AddressList comment=AS63420 address=157.53.65.0/24} on-error {}
:do {add list=$AddressList comment=AS63420 address=45.54.13.0/24} on-error {}
:do {add list=$AddressList comment=AS63420 address=45.54.25.0/24} on-error {}
