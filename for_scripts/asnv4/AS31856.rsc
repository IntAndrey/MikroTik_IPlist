...
:do {add list=$AddressList comment=AS31856 address=168.253.32.0/21} on-error {}
:do {add list=$AddressList comment=AS31856 address=168.253.40.0/22} on-error {}
:do {add list=$AddressList comment=AS31856 address=168.253.49.0/24} on-error {}
:do {add list=$AddressList comment=AS31856 address=168.253.50.0/23} on-error {}
:do {add list=$AddressList comment=AS31856 address=168.253.52.0/22} on-error {}
:do {add list=$AddressList comment=AS31856 address=196.44.176.0/23} on-error {}
...
:do {add list=$AddressList comment=AS31856 address=41.85.212.0/24} on-error {}
