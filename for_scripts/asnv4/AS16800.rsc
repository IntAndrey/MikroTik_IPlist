...
:do {add list=$AddressList comment=AS16800 address=163.201.128.0/23} on-error {}
:do {add list=$AddressList comment=AS16800 address=163.201.131.0/24} on-error {}
...
:do {add list=$AddressList comment=AS16800 address=163.201.223.0/24} on-error {}
:do {add list=$AddressList comment=AS16800 address=163.201.8.0/24} on-error {}
:do {add list=$AddressList comment=AS16800 address=163.201.92.0/23} on-error {}
:do {add list=$AddressList comment=AS16800 address=163.201.94.0/24} on-error {}
