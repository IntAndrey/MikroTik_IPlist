...
:do {add list=$AddressList comment=AS136093 address=103.111.92.0/23} on-error {}
:do {add list=$AddressList comment=AS136093 address=103.111.95.0/24} on-error {}
:do {add list=$AddressList comment=AS136093 address=103.111.96.0/22} on-error {}
...
:do {add list=$AddressList comment=AS136093 address=154.38.28.0/22} on-error {}
:do {add list=$AddressList comment=AS136093 address=154.47.148.0/22} on-error {}
:do {add list=$AddressList comment=AS136093 address=157.66.240.0/22} on-error {}
