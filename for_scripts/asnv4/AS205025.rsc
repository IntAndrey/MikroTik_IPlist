...
:do {add list=$AddressList comment=AS205025 address=62.101.161.0/24} on-error {}
:do {add list=$AddressList comment=AS205025 address=62.101.162.0/23} on-error {}
:do {add list=$AddressList comment=AS205025 address=62.101.164.0/24} on-error {}
:do {add list=$AddressList comment=AS205025 address=62.101.166.0/23} on-error {}
