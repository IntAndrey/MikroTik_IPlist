...
:do {add list=$AddressList comment=AS133865 address=103.98.248.0/23} on-error {}
:do {add list=$AddressList comment=AS133865 address=103.98.251.0/24} on-error {}
:do {add list=$AddressList comment=AS133865 address=103.98.252.0/22} on-error {}
