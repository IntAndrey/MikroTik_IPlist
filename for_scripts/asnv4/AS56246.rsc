...
:do {add list=$AddressList comment=AS56246 address=103.10.120.0/23} on-error {}
:do {add list=$AddressList comment=AS56246 address=103.10.122.0/24} on-error {}
...
:do {add list=$AddressList comment=AS56246 address=116.68.172.0/23} on-error {}
