...
:do {add list=$AddressList comment=AS12200 address=174.143.80.0/24} on-error {}
:do {add list=$AddressList comment=AS12200 address=192.65.36.0/24} on-error {}
...
:do {add list=$AddressList comment=AS12200 address=81.168.7.0/24} on-error {}
