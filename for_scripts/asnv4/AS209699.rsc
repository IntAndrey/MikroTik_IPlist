...
:do {add list=$AddressList comment=AS209699 address=216.23.100.0/23} on-error {}
:do {add list=$AddressList comment=AS209699 address=216.23.103.0/24} on-error {}
:do {add list=$AddressList comment=AS209699 address=216.23.88.0/24} on-error {}
