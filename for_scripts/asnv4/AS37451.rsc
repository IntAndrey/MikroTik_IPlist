...
:do {add list=$AddressList comment=AS37451 address=102.129.67.0/24} on-error {}
...
:do {add list=$AddressList comment=AS37451 address=102.129.81.0/24} on-error {}
...
:do {add list=$AddressList comment=AS37451 address=102.129.87.0/24} on-error {}
...
:do {add list=$AddressList comment=AS37451 address=154.53.209.0/24} on-error {}
:do {add list=$AddressList comment=AS37451 address=154.53.210.0/23} on-error {}
