...
:do {add list=$AddressList comment=AS202045 address=95.111.132.0/24} on-error {}
:do {add list=$AddressList comment=AS202045 address=95.111.138.0/23} on-error {}
:do {add list=$AddressList comment=AS202045 address=95.111.146.0/23} on-error {}
