...
:do {add list=$AddressList comment=AS152699 address=157.85.80.0/22} on-error {}
:do {add list=$AddressList comment=AS152699 address=157.85.84.0/23} on-error {}
:do {add list=$AddressList comment=AS152699 address=157.85.86.0/24} on-error {}
:do {add list=$AddressList comment=AS152699 address=157.85.88.0/21} on-error {}
