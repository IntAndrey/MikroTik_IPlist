...
:do {add list=$AddressList comment=AS210705 address=194.88.232.0/24} on-error {}
...
:do {add list=$AddressList comment=AS210705 address=46.249.110.0/24} on-error {}
:do {add list=$AddressList comment=AS210705 address=5.159.54.0/24} on-error {}
:do {add list=$AddressList comment=AS210705 address=77.72.80.0/24} on-error {}
:do {add list=$AddressList comment=AS210705 address=87.248.129.0/24} on-error {}
:do {add list=$AddressList comment=AS210705 address=87.248.149.0/24} on-error {}
