...
:do {add list=$AddressList comment=AS59432 address=5.134.112.0/24} on-error {}
:do {add list=$AddressList comment=AS59432 address=5.134.114.0/23} on-error {}
:do {add list=$AddressList comment=AS59432 address=5.134.116.0/22} on-error {}
