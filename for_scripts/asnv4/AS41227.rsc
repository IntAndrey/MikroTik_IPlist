...
:do {add list=$AddressList comment=AS41227 address=185.166.105.0/24} on-error {}
:do {add list=$AddressList comment=AS41227 address=185.248.32.0/24} on-error {}
:do {add list=$AddressList comment=AS41227 address=193.29.17.0/24} on-error {}
:do {add list=$AddressList comment=AS41227 address=193.29.18.0/24} on-error {}
...
:do {add list=$AddressList comment=AS41227 address=78.111.5.0/24} on-error {}
:do {add list=$AddressList comment=AS41227 address=78.111.6.0/24} on-error {}
:do {add list=$AddressList comment=AS41227 address=87.247.168.0/21} on-error {}
