...
:do {add list=$AddressList comment=AS51082 address=103.102.133.0/24} on-error {}
...
:do {add list=$AddressList comment=AS51082 address=174.140.226.0/24} on-error {}
...
:do {add list=$AddressList comment=AS51082 address=51.146.140.0/24} on-error {}
:do {add list=$AddressList comment=AS51082 address=51.194.54.0/24} on-error {}
...
:do {add list=$AddressList comment=AS51082 address=82.108.98.0/24} on-error {}
:do {add list=$AddressList comment=AS51082 address=87.76.177.0/24} on-error {}
