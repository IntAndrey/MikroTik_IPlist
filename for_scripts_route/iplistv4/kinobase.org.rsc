...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=179.43.151.32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.43.151.32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kinobase.org }
