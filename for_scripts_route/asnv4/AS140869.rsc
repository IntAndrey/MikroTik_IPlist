...
:if ([:len [/ip/route/find dst-address=108.165.20.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.165.20.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140869 }
:if ([:len [/ip/route/find dst-address=117.120.220.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.120.220.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140869 }
...
:if ([:len [/ip/route/find dst-address=122.0.168.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=122.0.168.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140869 }
:if ([:len [/ip/route/find dst-address=143.109.37.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.109.37.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140869 }
:if ([:len [/ip/route/find dst-address=144.225.137.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.225.137.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140869 }
...
:if ([:len [/ip/route/find dst-address=168.93.199.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.93.199.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140869 }
:if ([:len [/ip/route/find dst-address=170.62.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.62.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140869 }
...
:if ([:len [/ip/route/find dst-address=205.186.112.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.186.112.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140869 }
...
:if ([:len [/ip/route/find dst-address=50.114.184.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=50.114.184.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140869 }
