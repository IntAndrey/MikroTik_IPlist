...
:if ([:len [/ip/route/find dst-address=165.140.152.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.140.152.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400069 }
:if ([:len [/ip/route/find dst-address=165.140.154.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.140.154.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400069 }
