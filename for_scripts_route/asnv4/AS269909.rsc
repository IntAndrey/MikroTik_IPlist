...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=149.78.80.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.78.80.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS269909 }
...
:if ([:len [/ip/route/find dst-address=206.0.80.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.80.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS269909 }
