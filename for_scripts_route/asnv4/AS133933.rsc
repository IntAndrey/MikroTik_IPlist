...
:if ([:len [/ip/route/find dst-address=14.192.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=14.192.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133933 }
...
:if ([:len [/ip/route/find dst-address=14.192.141.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=14.192.141.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133933 }
:if ([:len [/ip/route/find dst-address=14.192.142.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=14.192.142.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133933 }
...
:if ([:len [/ip/route/find dst-address=43.247.122.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.247.122.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133933 }
