...
:if ([:len [/ip/route/find dst-address=160.20.4.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.20.4.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9830 }
...
:if ([:len [/ip/route/find dst-address=202.91.64.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.91.64.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9830 }
:if ([:len [/ip/route/find dst-address=202.91.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.91.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9830 }
:if ([:len [/ip/route/find dst-address=202.91.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.91.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9830 }
:if ([:len [/ip/route/find dst-address=202.91.78.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.91.78.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9830 }
