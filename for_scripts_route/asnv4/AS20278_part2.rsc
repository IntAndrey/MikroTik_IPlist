...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=64.44.88.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.44.88.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20278 }
:if ([:len [/ip/route/find dst-address=64.44.96.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.44.96.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20278 }
:if ([:len [/ip/route/find dst-address=64.44.99.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.44.99.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20278 }
...
:if ([:len [/ip/route/find dst-address=96.9.224.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.9.224.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20278 }
...
:if ([:len [/ip/route/find dst-address=96.9.230.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.9.230.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20278 }
