...
:if ([:len [/ip/route/find dst-address=103.243.82.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.243.82.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24323 }
:if ([:len [/ip/route/find dst-address=103.39.196.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.39.196.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24323 }
...
:if ([:len [/ip/route/find dst-address=43.245.192.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.245.192.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24323 }
