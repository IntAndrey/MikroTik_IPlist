...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=107.151.0.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.151.0.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55081 }
...
:if ([:len [/ip/route/find dst-address=209.205.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.205.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55081 }
...
:if ([:len [/ip/route/find dst-address=67.220.176.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.220.176.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55081 }
