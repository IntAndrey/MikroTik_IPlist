...
:if ([:len [/ip/route/find dst-address=154.22.142.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.22.142.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64010 }
:if ([:len [/ip/route/find dst-address=154.3.130.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.3.130.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64010 }
:if ([:len [/ip/route/find dst-address=154.9.202.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.9.202.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64010 }
