...
:if ([:len [/ip/route/find dst-address=185.21.8.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.21.8.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44051 }
...
:if ([:len [/ip/route/find dst-address=217.177.72.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.177.72.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44051 }
