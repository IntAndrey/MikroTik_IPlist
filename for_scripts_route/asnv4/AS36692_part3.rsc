...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=67.215.82.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.215.82.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36692 }
:if ([:len [/ip/route/find dst-address=67.215.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.215.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36692 }
