...
:if ([:len [/ip/route/find dst-address=118.213.141.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=118.213.141.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59223 }
...
:if ([:len [/ip/route/find dst-address=125.72.126.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=125.72.126.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59223 }
...
:if ([:len [/ip/route/find dst-address=125.72.141.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=125.72.141.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59223 }
...
:if ([:len [/ip/route/find dst-address=125.72.144.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=125.72.144.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59223 }
