...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=147.125.199.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=147.125.199.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133153 }
:if ([:len [/ip/route/find dst-address=162.141.152.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.141.152.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133153 }
...
:if ([:len [/ip/route/find dst-address=85.237.70.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.237.70.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133153 }
