...
:if ([:len [/ip/route/find dst-address=198.60.234.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.60.234.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2727 }
:if ([:len [/ip/route/find dst-address=198.60.236.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.60.236.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2727 }
