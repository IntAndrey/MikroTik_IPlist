...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=158.120.32.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.120.32.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53407 }
:if ([:len [/ip/route/find dst-address=158.120.36.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.120.36.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53407 }
:if ([:len [/ip/route/find dst-address=158.120.38.0/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.120.38.0/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53407 }
:if ([:len [/ip/route/find dst-address=158.120.38.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.120.38.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53407 }
:if ([:len [/ip/route/find dst-address=158.120.38.32/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.120.38.32/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53407 }
:if ([:len [/ip/route/find dst-address=158.120.38.48/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.120.38.48/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53407 }
:if ([:len [/ip/route/find dst-address=158.120.38.52/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.120.38.52/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53407 }
:if ([:len [/ip/route/find dst-address=158.120.38.54/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.120.38.54/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53407 }
:if ([:len [/ip/route/find dst-address=158.120.38.56/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.120.38.56/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53407 }
:if ([:len [/ip/route/find dst-address=158.120.38.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.120.38.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53407 }
:if ([:len [/ip/route/find dst-address=158.120.39.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.120.39.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53407 }
