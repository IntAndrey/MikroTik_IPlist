...
:if ([:len [/ip/route/find dst-address=92.241.24.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.241.24.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58002 }
:if ([:len [/ip/route/find dst-address=92.241.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.241.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58002 }
