...
:if ([:len [/ip/route/find dst-address=57.188.20.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=57.188.20.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205080 }
:if ([:len [/ip/route/find dst-address=57.188.22.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=57.188.22.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205080 }
...
:if ([:len [/ip/route/find dst-address=57.188.56.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=57.188.56.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205080 }
