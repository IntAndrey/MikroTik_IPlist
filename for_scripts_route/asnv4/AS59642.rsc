...
:if ([:len [/ip/route/find dst-address=84.32.108.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.32.108.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59642 }
:if ([:len [/ip/route/find dst-address=84.32.176.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.32.176.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59642 }
...
:if ([:len [/ip/route/find dst-address=88.216.92.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.216.92.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59642 }
