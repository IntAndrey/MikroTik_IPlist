...
:if ([:len [/ip/route/find dst-address=152.89.253.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.89.253.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213535 }
...
:if ([:len [/ip/route/find dst-address=198.105.115.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.105.115.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213535 }
...
:if ([:len [/ip/route/find dst-address=45.43.75.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.43.75.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213535 }
:if ([:len [/ip/route/find dst-address=45.43.92.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.43.92.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213535 }
...
:if ([:len [/ip/route/find dst-address=45.91.248.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.91.248.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213535 }
...
:if ([:len [/ip/route/find dst-address=64.49.15.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.49.15.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213535 }
:if ([:len [/ip/route/find dst-address=92.119.166.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.119.166.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213535 }
