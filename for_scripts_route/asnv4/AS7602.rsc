...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.200.60.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.200.60.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7602 }
...
:if ([:len [/ip/route/find dst-address=116.118.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.118.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7602 }
...
:if ([:len [/ip/route/find dst-address=116.118.8.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.118.8.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7602 }
...
:if ([:len [/ip/route/find dst-address=180.93.128.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.93.128.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7602 }
...
:if ([:len [/ip/route/find dst-address=180.93.160.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.93.160.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7602 }
