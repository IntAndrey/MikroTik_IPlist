...
:if ([:len [/ip/route/find dst-address=185.232.93.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.232.93.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134196 }
:if ([:len [/ip/route/find dst-address=185.232.94.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.232.94.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134196 }
