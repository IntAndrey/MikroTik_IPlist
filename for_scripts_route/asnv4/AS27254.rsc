...
:if ([:len [/ip/route/find dst-address=64.147.40.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.147.40.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27254 }
