...
:if ([:len [/ip/route/find dst-address=64.77.220.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.77.220.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4452 }
