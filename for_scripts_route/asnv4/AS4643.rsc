...
:if ([:len [/ip/route/find dst-address=203.14.89.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.14.89.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4643 }
:if ([:len [/ip/route/find dst-address=203.14.90.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.14.90.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4643 }
