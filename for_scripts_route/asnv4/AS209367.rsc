...
:if ([:len [/ip/route/find dst-address=194.226.184.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.226.184.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209367 }
...
:if ([:len [/ip/route/find dst-address=194.85.200.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.85.200.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209367 }
