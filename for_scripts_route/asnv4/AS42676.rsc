...
:if ([:len [/ip/route/find dst-address=185.25.68.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.25.68.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42676 }
:if ([:len [/ip/route/find dst-address=37.157.232.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.157.232.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42676 }
