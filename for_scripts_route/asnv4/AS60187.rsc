...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=151.133.0.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.133.0.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60187 }
...
:if ([:len [/ip/route/find dst-address=151.133.236.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.133.236.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60187 }
...
:if ([:len [/ip/route/find dst-address=151.133.32.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.133.32.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60187 }
:if ([:len [/ip/route/find dst-address=151.133.48.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.133.48.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60187 }
