...
:if ([:len [/ip/route/find dst-address=195.253.66.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.253.66.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8561 }
...
:if ([:len [/ip/route/find dst-address=195.253.97.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.253.97.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8561 }
:if ([:len [/ip/route/find dst-address=195.253.98.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.253.98.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8561 }
