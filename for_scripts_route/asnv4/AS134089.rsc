...
:if ([:len [/ip/route/find dst-address=203.156.65.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.156.65.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134089 }
:if ([:len [/ip/route/find dst-address=203.156.66.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.156.66.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134089 }
