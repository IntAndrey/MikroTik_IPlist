...
:if ([:len [/ip/route/find dst-address=195.230.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.230.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6846 }
:if ([:len [/ip/route/find dst-address=195.238.180.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.238.180.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6846 }
