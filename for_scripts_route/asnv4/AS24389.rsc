...
:if ([:len [/ip/route/find dst-address=119.30.34.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.30.34.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24389 }
...
:if ([:len [/ip/route/find dst-address=119.30.44.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.30.44.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24389 }
...
:if ([:len [/ip/route/find dst-address=37.111.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.111.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24389 }
:if ([:len [/ip/route/find dst-address=37.111.200.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.111.200.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24389 }
...
:if ([:len [/ip/route/find dst-address=37.111.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.111.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24389 }
:if ([:len [/ip/route/find dst-address=37.111.232.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.111.232.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24389 }
:if ([:len [/ip/route/find dst-address=37.111.237.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.111.237.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24389 }
:if ([:len [/ip/route/find dst-address=37.111.238.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.111.238.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24389 }
