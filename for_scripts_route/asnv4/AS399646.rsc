...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=108.165.12.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.165.12.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399646 }
:if ([:len [/ip/route/find dst-address=108.165.120.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.165.120.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399646 }
...
:if ([:len [/ip/route/find dst-address=143.20.141.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.20.141.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399646 }
:if ([:len [/ip/route/find dst-address=143.20.143.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.20.143.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399646 }
