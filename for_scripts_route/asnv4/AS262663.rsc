...
:if ([:len [/ip/route/find dst-address=186.216.54.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.216.54.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
...
:if ([:len [/ip/route/find dst-address=187.62.224.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.62.224.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
:if ([:len [/ip/route/find dst-address=187.62.226.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.62.226.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
