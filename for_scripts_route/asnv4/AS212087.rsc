...
:if ([:len [/ip/route/find dst-address=149.71.44.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.71.44.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212087 }
...
:if ([:len [/ip/route/find dst-address=154.56.152.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.56.152.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212087 }
