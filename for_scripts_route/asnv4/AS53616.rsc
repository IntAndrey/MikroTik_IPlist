...
:if ([:len [/ip/route/find dst-address=185.219.189.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.219.189.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53616 }
...
:if ([:len [/ip/route/find dst-address=217.217.35.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.217.35.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53616 }
