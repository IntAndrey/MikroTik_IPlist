...
:if ([:len [/ip/route/find dst-address=221.120.184.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=221.120.184.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17975 }
:if ([:len [/ip/route/find dst-address=221.120.189.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=221.120.189.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17975 }
:if ([:len [/ip/route/find dst-address=221.120.190.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=221.120.190.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17975 }
