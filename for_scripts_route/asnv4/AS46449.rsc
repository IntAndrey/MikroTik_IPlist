...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=199.115.160.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.115.160.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46449 }
:if ([:len [/ip/route/find dst-address=199.89.56.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.89.56.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46449 }
:if ([:len [/ip/route/find dst-address=208.101.239.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.101.239.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46449 }
:if ([:len [/ip/route/find dst-address=208.95.208.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.95.208.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46449 }
:if ([:len [/ip/route/find dst-address=24.50.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=24.50.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46449 }
...
:if ([:len [/ip/route/find dst-address=68.65.176.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.65.176.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46449 }
