...
:if ([:len [/ip/route/find dst-address=199.247.86.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.247.86.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27239 }
...
:if ([:len [/ip/route/find dst-address=68.67.114.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.67.114.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27239 }
