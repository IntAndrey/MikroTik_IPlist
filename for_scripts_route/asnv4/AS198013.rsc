...
:if ([:len [/ip/route/find dst-address=94.185.104.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.185.104.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198013 }
:if ([:len [/ip/route/find dst-address=94.185.107.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.185.107.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198013 }
