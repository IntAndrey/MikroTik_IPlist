...
:if ([:len [/ip/route/find dst-address=208.90.188.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.90.188.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36489 }
