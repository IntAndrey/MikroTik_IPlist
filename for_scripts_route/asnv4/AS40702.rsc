...
:if ([:len [/ip/route/find dst-address=64.203.233.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.203.233.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40702 }
...
:if ([:len [/ip/route/find dst-address=66.111.66.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.111.66.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40702 }
:if ([:len [/ip/route/find dst-address=66.111.86.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.111.86.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40702 }
