...
:if ([:len [/ip/route/find dst-address=5.134.112.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.134.112.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59432 }
:if ([:len [/ip/route/find dst-address=5.134.114.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.134.114.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59432 }
:if ([:len [/ip/route/find dst-address=5.134.116.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.134.116.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59432 }
