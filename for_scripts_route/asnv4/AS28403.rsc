...
:if ([:len [/ip/route/find dst-address=200.68.148.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.68.148.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28403 }
:if ([:len [/ip/route/find dst-address=200.68.151.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.68.151.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28403 }
...
:if ([:len [/ip/route/find dst-address=200.68.189.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.68.189.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28403 }
