...
:if ([:len [/ip/route/find dst-address=213.189.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.189.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9155 }
...
:if ([:len [/ip/route/find dst-address=62.150.200.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.150.200.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9155 }
