...
:if ([:len [/ip/route/find dst-address=155.117.147.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.117.147.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202673 }
:if ([:len [/ip/route/find dst-address=155.117.197.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.117.197.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202673 }
...
:if ([:len [/ip/route/find dst-address=178.253.224.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.253.224.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202673 }
...
:if ([:len [/ip/route/find dst-address=185.245.63.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.245.63.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202673 }
