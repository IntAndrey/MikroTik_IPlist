...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=204.108.128.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.108.128.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20413 }
:if ([:len [/ip/route/find dst-address=204.108.136.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.108.136.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20413 }
:if ([:len [/ip/route/find dst-address=204.108.141.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.108.141.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20413 }
:if ([:len [/ip/route/find dst-address=204.108.142.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.108.142.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20413 }
