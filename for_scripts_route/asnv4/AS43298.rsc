...
:if ([:len [/ip/route/find dst-address=185.71.64.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.71.64.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43298 }
:if ([:len [/ip/route/find dst-address=185.71.67.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.71.67.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43298 }
