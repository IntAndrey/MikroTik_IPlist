...
:if ([:len [/ip/route/find dst-address=41.92.202.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.92.202.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328866 }
...
:if ([:len [/ip/route/find dst-address=41.92.252.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.92.252.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328866 }
:if ([:len [/ip/route/find dst-address=41.92.254.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.92.254.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328866 }
