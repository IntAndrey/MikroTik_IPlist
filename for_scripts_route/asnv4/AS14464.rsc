...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=131.109.0.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.109.0.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14464 }
:if ([:len [/ip/route/find dst-address=131.109.12.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.109.12.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14464 }
...
:if ([:len [/ip/route/find dst-address=131.109.15.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.109.15.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14464 }
:if ([:len [/ip/route/find dst-address=131.109.16.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.109.16.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14464 }
...
:if ([:len [/ip/route/find dst-address=131.109.8.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.109.8.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14464 }
