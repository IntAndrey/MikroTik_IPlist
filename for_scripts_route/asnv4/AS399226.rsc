...
:if ([:len [/ip/route/find dst-address=23.153.228.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.153.228.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399226 }
...
:if ([:len [/ip/route/find dst-address=38.159.112.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.159.112.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399226 }
