...
:if ([:len [/ip/route/find dst-address=161.107.30.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.107.30.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17275 }
:if ([:len [/ip/route/find dst-address=161.107.44.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.107.44.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17275 }
:if ([:len [/ip/route/find dst-address=161.107.56.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.107.56.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17275 }
