...
:if ([:len [/ip/route/find dst-address=103.98.248.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.98.248.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133865 }
:if ([:len [/ip/route/find dst-address=103.98.251.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.98.251.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133865 }
:if ([:len [/ip/route/find dst-address=103.98.252.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.98.252.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133865 }
