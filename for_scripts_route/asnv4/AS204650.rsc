...
:if ([:len [/ip/route/find dst-address=2.189.96.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.189.96.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204650 }
