...
:if ([:len [/ip/route/find dst-address=200.152.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.152.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28590 }
...
:if ([:len [/ip/route/find dst-address=200.218.232.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.218.232.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28590 }
