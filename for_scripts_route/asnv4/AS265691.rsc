...
:if ([:len [/ip/route/find dst-address=209.45.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.45.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265691 }
:if ([:len [/ip/route/find dst-address=209.45.8.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.45.8.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265691 }
