...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=104.171.204.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.171.204.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22297 }
...
:if ([:len [/ip/route/find dst-address=173.239.19.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=173.239.19.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22297 }
:if ([:len [/ip/route/find dst-address=173.239.20.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=173.239.20.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22297 }
...
:if ([:len [/ip/route/find dst-address=199.246.24.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.246.24.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22297 }
...
:if ([:len [/ip/route/find dst-address=74.206.248.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.206.248.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22297 }
:if ([:len [/ip/route/find dst-address=74.206.254.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.206.254.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22297 }
