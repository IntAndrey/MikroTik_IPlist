...
:if ([:len [/ip/route/find dst-address=5.42.108.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.42.108.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39493 }
:if ([:len [/ip/route/find dst-address=5.42.112.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.42.112.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39493 }
