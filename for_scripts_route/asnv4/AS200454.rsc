...
:if ([:len [/ip/route/find dst-address=199.16.241.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.16.241.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200454 }
