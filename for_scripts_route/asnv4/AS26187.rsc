...
:if ([:len [/ip/route/find dst-address=23.147.28.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.147.28.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26187 }
...
:if ([:len [/ip/route/find dst-address=23.153.236.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.153.236.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26187 }
