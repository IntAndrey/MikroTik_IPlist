...
:if ([:len [/ip/route/find dst-address=5.152.186.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.152.186.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203160 }
:if ([:len [/ip/route/find dst-address=5.152.188.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.152.188.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203160 }
:if ([:len [/ip/route/find dst-address=91.209.6.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.209.6.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203160 }
