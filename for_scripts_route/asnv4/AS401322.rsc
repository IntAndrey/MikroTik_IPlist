...
:if ([:len [/ip/route/find dst-address=173.44.162.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=173.44.162.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401322 }
...
:if ([:len [/ip/route/find dst-address=23.231.15.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.231.15.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401322 }
...
:if ([:len [/ip/route/find dst-address=50.2.157.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=50.2.157.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401322 }
