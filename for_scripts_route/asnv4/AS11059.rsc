...
:if ([:len [/ip/route/find dst-address=209.101.222.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.101.222.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
...
:if ([:len [/ip/route/find dst-address=69.33.32.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.33.32.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
:if ([:len [/ip/route/find dst-address=74.2.128.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.2.128.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
...
:if ([:len [/ip/route/find dst-address=76.9.110.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.9.110.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
