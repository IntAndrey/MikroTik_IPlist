...
:if ([:len [/ip/route/find dst-address=94.184.24.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.184.24.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211056 }
:if ([:len [/ip/route/find dst-address=94.184.28.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.184.28.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211056 }
:if ([:len [/ip/route/find dst-address=94.184.31.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.184.31.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211056 }
:if ([:len [/ip/route/find dst-address=94.184.5.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.184.5.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211056 }
