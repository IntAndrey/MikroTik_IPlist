...
:if ([:len [/ip/route/find dst-address=195.10.240.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.10.240.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8553 }
