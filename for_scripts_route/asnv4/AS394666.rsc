...
:if ([:len [/ip/route/find dst-address=216.165.126.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.165.126.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394666 }
