...
:if ([:len [/ip/route/find dst-address=83.219.236.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.219.236.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51200 }
:if ([:len [/ip/route/find dst-address=83.219.252.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.219.252.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51200 }
