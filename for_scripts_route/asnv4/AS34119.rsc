...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=138.226.208.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.226.208.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34119 }
:if ([:len [/ip/route/find dst-address=149.143.150.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.143.150.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34119 }
