...
:if ([:len [/ip/route/find dst-address=101.53.47.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=101.53.47.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24176 }
:if ([:len [/ip/route/find dst-address=101.53.59.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=101.53.59.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24176 }
