...
:if ([:len [/ip/route/find dst-address=23.41.0.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.41.0.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23693 }
...
:if ([:len [/ip/route/find dst-address=39.192.0.0/10 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=39.192.0.0/10 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23693 }
