...
:if ([:len [/ip/route/find dst-address=194.165.144.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.165.144.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8376 }
:if ([:len [/ip/route/find dst-address=194.165.146.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.165.146.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8376 }
:if ([:len [/ip/route/find dst-address=194.165.148.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.165.148.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8376 }
:if ([:len [/ip/route/find dst-address=194.165.152.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.165.152.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8376 }
...
:if ([:len [/ip/route/find dst-address=94.249.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.249.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8376 }
