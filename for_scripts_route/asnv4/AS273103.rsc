...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=170.62.156.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.62.156.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS273103 }
...
:if ([:len [/ip/route/find dst-address=38.191.192.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.191.192.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS273103 }
