...
:if ([:len [/ip/route/find dst-address=156.255.0.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.255.0.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139646 }
:if ([:len [/ip/route/find dst-address=45.200.14.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.200.14.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139646 }
:if ([:len [/ip/route/find dst-address=45.200.19.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.200.19.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139646 }
