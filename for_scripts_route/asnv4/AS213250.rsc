...
:if ([:len [/ip/route/find dst-address=5.175.166.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.175.166.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213250 }
...
:if ([:len [/ip/route/find dst-address=5.231.108.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.231.108.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213250 }
...
:if ([:len [/ip/route/find dst-address=5.83.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.83.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213250 }
...
:if ([:len [/ip/route/find dst-address=91.192.10.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.192.10.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213250 }
