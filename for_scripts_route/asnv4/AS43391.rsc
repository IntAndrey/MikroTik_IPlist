...
:if ([:len [/ip/route/find dst-address=77.223.146.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.223.146.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43391 }
...
:if ([:len [/ip/route/find dst-address=91.191.165.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.191.165.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43391 }
:if ([:len [/ip/route/find dst-address=91.191.168.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.191.168.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43391 }
