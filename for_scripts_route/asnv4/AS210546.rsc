...
:if ([:len [/ip/route/find dst-address=178.236.244.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.236.244.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210546 }
:if ([:len [/ip/route/find dst-address=77.91.70.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.91.70.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210546 }
