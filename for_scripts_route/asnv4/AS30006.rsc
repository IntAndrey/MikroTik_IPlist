...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=142.248.8.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.248.8.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30006 }
:if ([:len [/ip/route/find dst-address=23.129.84.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.129.84.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30006 }
