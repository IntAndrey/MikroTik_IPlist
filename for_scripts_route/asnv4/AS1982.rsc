...
:if ([:len [/ip/route/find dst-address=204.57.215.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.57.215.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1982 }
...
:if ([:len [/ip/route/find dst-address=206.63.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.63.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1982 }
