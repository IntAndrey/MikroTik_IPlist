...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.145.60.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.145.60.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42960 }
:if ([:len [/ip/route/find dst-address=103.153.4.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.153.4.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42960 }
...
:if ([:len [/ip/route/find dst-address=103.24.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.24.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42960 }
...
:if ([:len [/ip/route/find dst-address=103.96.140.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.96.140.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42960 }
...
:if ([:len [/ip/route/find dst-address=149.104.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.104.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42960 }
:if ([:len [/ip/route/find dst-address=149.104.4.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.104.4.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42960 }
