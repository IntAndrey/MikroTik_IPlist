...
:if ([:len [/ip/route/find dst-address=151.158.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.158.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138926 }
:if ([:len [/ip/route/find dst-address=38.159.120.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.159.120.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138926 }
