...
:if ([:len [/ip/route/find dst-address=38.45.52.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.45.52.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215596 }
