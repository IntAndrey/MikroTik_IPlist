...
:if ([:len [/ip/route/find dst-address=103.253.212.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.253.212.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58487 }
:if ([:len [/ip/route/find dst-address=103.3.233.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.3.233.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58487 }
