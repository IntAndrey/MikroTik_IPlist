...
:if ([:len [/ip/route/find dst-address=202.141.139.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.141.139.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2697 }
:if ([:len [/ip/route/find dst-address=202.141.140.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.141.140.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2697 }
