...
:if ([:len [/ip/route/find dst-address=67.7.152.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.7.152.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393789 }
:if ([:len [/ip/route/find dst-address=67.7.154.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.7.154.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393789 }
:if ([:len [/ip/route/find dst-address=67.7.154.128/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.7.154.128/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393789 }
:if ([:len [/ip/route/find dst-address=67.7.154.160/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.7.154.160/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393789 }
:if ([:len [/ip/route/find dst-address=67.7.154.164/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.7.154.164/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393789 }
:if ([:len [/ip/route/find dst-address=67.7.154.167/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.7.154.167/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393789 }
:if ([:len [/ip/route/find dst-address=67.7.154.168/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.7.154.168/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393789 }
:if ([:len [/ip/route/find dst-address=67.7.154.176/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.7.154.176/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393789 }
:if ([:len [/ip/route/find dst-address=67.7.154.192/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.7.154.192/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393789 }
:if ([:len [/ip/route/find dst-address=67.7.155.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.7.155.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393789 }
...
:if ([:len [/ip/route/find dst-address=67.7.184.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.7.184.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393789 }
