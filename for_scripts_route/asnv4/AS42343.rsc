...
:if ([:len [/ip/route/find dst-address=84.240.96.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.240.96.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42343 }
