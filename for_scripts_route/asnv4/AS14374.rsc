...
:if ([:len [/ip/route/find dst-address=208.99.224.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.99.224.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14374 }
:if ([:len [/ip/route/find dst-address=208.99.226.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.99.226.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14374 }
:if ([:len [/ip/route/find dst-address=208.99.228.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.99.228.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14374 }
:if ([:len [/ip/route/find dst-address=208.99.232.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.99.232.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14374 }
...
:if ([:len [/ip/route/find dst-address=66.211.64.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.211.64.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14374 }
