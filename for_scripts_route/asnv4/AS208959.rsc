...
:if ([:len [/ip/route/find dst-address=216.163.184.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.163.184.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208959 }
:if ([:len [/ip/route/find dst-address=216.163.186.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.163.186.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208959 }
