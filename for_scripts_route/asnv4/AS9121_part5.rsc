...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=95.15.160.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.15.160.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9121 }
:if ([:len [/ip/route/find dst-address=95.15.192.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.15.192.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9121 }
:if ([:len [/ip/route/find dst-address=95.15.208.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.15.208.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9121 }
:if ([:len [/ip/route/find dst-address=95.15.216.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.15.216.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9121 }
:if ([:len [/ip/route/find dst-address=95.15.218.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.15.218.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9121 }
:if ([:len [/ip/route/find dst-address=95.15.220.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.15.220.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9121 }
:if ([:len [/ip/route/find dst-address=95.15.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.15.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9121 }
:if ([:len [/ip/route/find dst-address=95.15.240.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.15.240.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9121 }
:if ([:len [/ip/route/find dst-address=95.15.248.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.15.248.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9121 }
:if ([:len [/ip/route/find dst-address=95.15.252.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.15.252.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9121 }
