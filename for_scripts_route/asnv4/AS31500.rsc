...
:if ([:len [/ip/route/find dst-address=94.124.180.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.124.180.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31500 }
:if ([:len [/ip/route/find dst-address=94.124.182.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.124.182.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31500 }
