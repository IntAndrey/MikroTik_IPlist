...
:if ([:len [/ip/route/find dst-address=91.148.0.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.148.0.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31117 }
:if ([:len [/ip/route/find dst-address=91.148.32.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.148.32.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31117 }
:if ([:len [/ip/route/find dst-address=91.148.48.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.148.48.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31117 }
:if ([:len [/ip/route/find dst-address=91.148.56.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.148.56.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31117 }
:if ([:len [/ip/route/find dst-address=91.148.60.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.148.60.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31117 }
:if ([:len [/ip/route/find dst-address=91.148.62.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.148.62.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31117 }
