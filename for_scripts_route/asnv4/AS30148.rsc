...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.93.229.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.93.229.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30148 }
:if ([:len [/ip/route/find dst-address=185.93.230.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.93.230.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30148 }
...
:if ([:len [/ip/route/find dst-address=208.109.0.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.109.0.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30148 }
