...
:if ([:len [/ip/route/find dst-address=186.209.108.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.209.108.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53153 }
...
:if ([:len [/ip/route/find dst-address=187.61.100.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.61.100.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53153 }
:if ([:len [/ip/route/find dst-address=187.61.103.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.61.103.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53153 }
:if ([:len [/ip/route/find dst-address=187.61.105.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.61.105.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53153 }
:if ([:len [/ip/route/find dst-address=187.61.107.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.61.107.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53153 }
:if ([:len [/ip/route/find dst-address=187.61.108.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.61.108.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53153 }
