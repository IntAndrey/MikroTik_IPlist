...
:if ([:len [/ip/route/find dst-address=195.69.231.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.69.231.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209193 }
:if ([:len [/ip/route/find dst-address=5.175.144.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.175.144.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209193 }
:if ([:len [/ip/route/find dst-address=5.175.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.175.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209193 }
:if ([:len [/ip/route/find dst-address=5.175.148.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.175.148.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209193 }
