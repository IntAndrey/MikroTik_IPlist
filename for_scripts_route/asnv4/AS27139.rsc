...
:if ([:len [/ip/route/find dst-address=128.26.120.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=128.26.120.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27139 }
:if ([:len [/ip/route/find dst-address=128.26.122.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=128.26.122.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27139 }
...
:if ([:len [/ip/route/find dst-address=198.218.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.218.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27139 }
:if ([:len [/ip/route/find dst-address=198.219.170.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.219.170.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27139 }
:if ([:len [/ip/route/find dst-address=205.58.100.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.58.100.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27139 }
:if ([:len [/ip/route/find dst-address=205.58.103.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.58.103.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27139 }
:if ([:len [/ip/route/find dst-address=205.60.234.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.60.234.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27139 }
...
:if ([:len [/ip/route/find dst-address=214.6.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=214.6.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27139 }
