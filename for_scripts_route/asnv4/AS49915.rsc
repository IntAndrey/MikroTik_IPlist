...
:if ([:len [/ip/route/find dst-address=162.43.176.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.43.176.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49915 }
...
:if ([:len [/ip/route/find dst-address=51.146.0.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=51.146.0.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49915 }
