...
:if ([:len [/ip/route/find dst-address=81.173.44.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.173.44.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51942 }
:if ([:len [/ip/route/find dst-address=81.173.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.173.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51942 }
