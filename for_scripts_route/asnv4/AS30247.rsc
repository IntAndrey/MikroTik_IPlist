...
:if ([:len [/ip/route/find dst-address=38.92.4.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.92.4.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30247 }
:if ([:len [/ip/route/find dst-address=38.92.5.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.92.5.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30247 }
:if ([:len [/ip/route/find dst-address=38.92.5.128/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.92.5.128/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30247 }
:if ([:len [/ip/route/find dst-address=38.92.5.192/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.92.5.192/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30247 }
:if ([:len [/ip/route/find dst-address=38.92.5.224/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.92.5.224/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30247 }
:if ([:len [/ip/route/find dst-address=38.92.5.240/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.92.5.240/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30247 }
:if ([:len [/ip/route/find dst-address=38.92.5.248/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.92.5.248/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30247 }
:if ([:len [/ip/route/find dst-address=38.92.5.250/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.92.5.250/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30247 }
:if ([:len [/ip/route/find dst-address=38.92.5.252/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.92.5.252/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30247 }
:if ([:len [/ip/route/find dst-address=38.92.6.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.92.6.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30247 }
