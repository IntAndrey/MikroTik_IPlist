...
:if ([:len [/ip/route/find dst-address=141.98.188.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.98.188.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33993 }
...
:if ([:len [/ip/route/find dst-address=45.136.114.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.136.114.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33993 }
...
:if ([:len [/ip/route/find dst-address=45.15.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.15.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33993 }
:if ([:len [/ip/route/find dst-address=45.15.147.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.15.147.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33993 }
