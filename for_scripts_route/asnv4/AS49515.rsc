...
:if ([:len [/ip/route/find dst-address=212.91.144.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.91.144.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49515 }
