...
:if ([:len [/ip/route/find dst-address=195.178.139.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.178.139.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3319 }
...
:if ([:len [/ip/route/find dst-address=195.178.154.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.178.154.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3319 }
...
:if ([:len [/ip/route/find dst-address=77.47.252.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.47.252.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3319 }
