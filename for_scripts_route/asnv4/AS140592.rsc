...
:if ([:len [/ip/route/find dst-address=160.96.252.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.96.252.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140592 }
