...
:if ([:len [/ip/route/find dst-address=159.220.157.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.220.157.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24012 }
...
:if ([:len [/ip/route/find dst-address=159.220.161.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.220.161.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24012 }
