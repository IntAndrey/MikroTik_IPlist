...
:if ([:len [/ip/route/find dst-address=205.220.224.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.220.224.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396998 }
:if ([:len [/ip/route/find dst-address=205.220.228.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.220.228.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396998 }
