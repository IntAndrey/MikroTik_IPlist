...
:if ([:len [/ip/route/find dst-address=189.76.68.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=189.76.68.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52752 }
:if ([:len [/ip/route/find dst-address=189.76.71.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=189.76.71.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52752 }
