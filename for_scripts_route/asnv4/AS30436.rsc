...
:if ([:len [/ip/route/find dst-address=216.189.125.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.189.125.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30436 }
:if ([:len [/ip/route/find dst-address=216.189.126.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.189.126.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30436 }
