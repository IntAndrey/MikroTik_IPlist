...
:if ([:len [/ip/route/find dst-address=91.191.0.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.191.0.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35567 }
:if ([:len [/ip/route/find dst-address=91.191.11.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.191.11.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35567 }
:if ([:len [/ip/route/find dst-address=91.191.12.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.191.12.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35567 }
...
:if ([:len [/ip/route/find dst-address=91.191.24.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.191.24.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35567 }
:if ([:len [/ip/route/find dst-address=91.191.27.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.191.27.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35567 }
:if ([:len [/ip/route/find dst-address=91.191.28.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.191.28.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35567 }
...
:if ([:len [/ip/route/find dst-address=91.191.8.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.191.8.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35567 }
