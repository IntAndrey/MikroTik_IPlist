...
:if ([:len [/ip/route/find dst-address=185.84.32.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.84.32.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35807 }
