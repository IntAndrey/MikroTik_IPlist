...
:if ([:len [/ip/route/find dst-address=46.38.136.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.38.136.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201949 }
...
:if ([:len [/ip/route/find dst-address=77.93.136.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.93.136.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201949 }
