...
:if ([:len [/ip/route/find dst-address=141.195.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.195.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22184 }
