...
:if ([:len [/ip/route/find dst-address=101.53.32.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=101.53.32.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24173 }
...
:if ([:len [/ip/route/find dst-address=101.53.40.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=101.53.40.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24173 }
:if ([:len [/ip/route/find dst-address=101.53.44.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=101.53.44.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24173 }
:if ([:len [/ip/route/find dst-address=101.53.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=101.53.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24173 }
:if ([:len [/ip/route/find dst-address=101.53.48.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=101.53.48.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24173 }
...
:if ([:len [/ip/route/find dst-address=154.81.60.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.81.60.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24173 }
