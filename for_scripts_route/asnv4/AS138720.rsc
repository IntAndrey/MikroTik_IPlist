...
:if ([:len [/ip/route/find dst-address=103.171.206.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.171.206.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138720 }
