...
:if ([:len [/ip/route/find dst-address=94.20.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.20.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49345 }
:if ([:len [/ip/route/find dst-address=94.20.55.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.20.55.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49345 }
