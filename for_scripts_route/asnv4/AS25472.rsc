...
:if ([:len [/ip/route/find dst-address=188.73.200.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.73.200.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25472 }
...
:if ([:len [/ip/route/find dst-address=212.152.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.152.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25472 }
