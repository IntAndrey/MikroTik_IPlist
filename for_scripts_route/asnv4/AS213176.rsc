...
:if ([:len [/ip/route/find dst-address=209.35.240.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.35.240.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213176 }
:if ([:len [/ip/route/find dst-address=209.35.243.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.35.243.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213176 }
:if ([:len [/ip/route/find dst-address=209.35.244.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.35.244.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213176 }
...
:if ([:len [/ip/route/find dst-address=209.35.252.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.35.252.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213176 }
...
:if ([:len [/ip/route/find dst-address=85.155.128.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.155.128.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213176 }
