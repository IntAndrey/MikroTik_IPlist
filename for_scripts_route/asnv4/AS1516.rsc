...
:if ([:len [/ip/route/find dst-address=143.86.100.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.86.100.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1516 }
...
:if ([:len [/ip/route/find dst-address=155.28.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.28.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1516 }
