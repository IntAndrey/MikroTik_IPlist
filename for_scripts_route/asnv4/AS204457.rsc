...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=131.222.230.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.222.230.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204457 }
:if ([:len [/ip/route/find dst-address=131.222.232.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.222.232.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204457 }
...
:if ([:len [/ip/route/find dst-address=188.125.168.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.125.168.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204457 }
