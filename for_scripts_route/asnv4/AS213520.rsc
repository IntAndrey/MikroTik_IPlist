...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=144.31.116.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.31.116.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213520 }
:if ([:len [/ip/route/find dst-address=144.31.122.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.31.122.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213520 }
:if ([:len [/ip/route/find dst-address=144.31.134.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.31.134.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213520 }
...
:if ([:len [/ip/route/find dst-address=144.31.232.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.31.232.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213520 }
:if ([:len [/ip/route/find dst-address=144.31.62.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.31.62.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213520 }
...
:if ([:len [/ip/route/find dst-address=150.241.64.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.241.64.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213520 }
:if ([:len [/ip/route/find dst-address=150.241.78.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.241.78.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213520 }
