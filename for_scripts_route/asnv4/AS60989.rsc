...
:if ([:len [/ip/route/find dst-address=85.155.160.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.155.160.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60989 }
