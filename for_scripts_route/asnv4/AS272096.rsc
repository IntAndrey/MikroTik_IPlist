...
:if ([:len [/ip/route/find dst-address=149.174.32.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.174.32.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272096 }
...
:if ([:len [/ip/route/find dst-address=149.174.48.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.174.48.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272096 }
...
:if ([:len [/ip/route/find dst-address=149.174.58.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.174.58.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272096 }
