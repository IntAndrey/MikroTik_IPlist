...
:if ([:len [/ip/route/find dst-address=167.88.212.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.88.212.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1097 }
:if ([:len [/ip/route/find dst-address=167.88.222.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.88.222.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1097 }
:if ([:len [/ip/route/find dst-address=172.81.148.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.81.148.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1097 }
...
:if ([:len [/ip/route/find dst-address=23.152.68.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.152.68.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1097 }
:if ([:len [/ip/route/find dst-address=50.20.192.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=50.20.192.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1097 }
