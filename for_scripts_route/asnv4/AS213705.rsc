...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=153.51.164.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.51.164.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213705 }
:if ([:len [/ip/route/find dst-address=153.51.168.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.51.168.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213705 }
...
:if ([:len [/ip/route/find dst-address=153.51.53.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.51.53.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213705 }
:if ([:len [/ip/route/find dst-address=153.51.54.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.51.54.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213705 }
