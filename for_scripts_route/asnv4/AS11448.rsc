...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=134.22.128.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.22.128.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11448 }
:if ([:len [/ip/route/find dst-address=134.22.180.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.22.180.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11448 }
...
:if ([:len [/ip/route/find dst-address=66.111.80.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.111.80.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11448 }
