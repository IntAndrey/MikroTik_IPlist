...
:if ([:len [/ip/route/find dst-address=185.182.248.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.182.248.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44285 }
...
:if ([:len [/ip/route/find dst-address=46.28.72.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.28.72.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44285 }
...
:if ([:len [/ip/route/find dst-address=80.249.112.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.249.112.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44285 }
:if ([:len [/ip/route/find dst-address=80.249.114.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.249.114.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44285 }
:if ([:len [/ip/route/find dst-address=84.47.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.47.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44285 }
