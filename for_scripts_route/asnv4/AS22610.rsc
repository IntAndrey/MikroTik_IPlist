...
:if ([:len [/ip/route/find dst-address=74.116.80.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.116.80.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22610 }
:if ([:len [/ip/route/find dst-address=74.116.82.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.116.82.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22610 }
