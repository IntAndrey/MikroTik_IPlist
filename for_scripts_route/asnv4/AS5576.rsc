...
:if ([:len [/ip/route/find dst-address=134.0.56.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.0.56.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5576 }
:if ([:len [/ip/route/find dst-address=134.0.58.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.0.58.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5576 }
