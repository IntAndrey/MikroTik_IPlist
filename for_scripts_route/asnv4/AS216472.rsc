...
:if ([:len [/ip/route/find dst-address=131.222.247.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.222.247.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216472 }
:if ([:len [/ip/route/find dst-address=131.222.250.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.222.250.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216472 }
:if ([:len [/ip/route/find dst-address=131.222.253.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.222.253.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216472 }
...
:if ([:len [/ip/route/find dst-address=176.117.104.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.117.104.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216472 }
:if ([:len [/ip/route/find dst-address=185.254.55.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.254.55.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216472 }
...
:if ([:len [/ip/route/find dst-address=212.108.115.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.108.115.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216472 }
...
:if ([:len [/ip/route/find dst-address=85.189.13.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.189.13.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216472 }
:if ([:len [/ip/route/find dst-address=85.189.9.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.189.9.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216472 }
