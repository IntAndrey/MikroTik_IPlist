...
:if ([:len [/ip/route/find dst-address=201.220.145.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.220.145.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52420 }
:if ([:len [/ip/route/find dst-address=201.220.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.220.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52420 }
:if ([:len [/ip/route/find dst-address=201.220.148.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.220.148.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52420 }
:if ([:len [/ip/route/find dst-address=201.220.152.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.220.152.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52420 }
