...
:if ([:len [/ip/route/find dst-address=87.110.250.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.110.250.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24921 }
