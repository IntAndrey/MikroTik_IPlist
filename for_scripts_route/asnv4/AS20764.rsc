...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.121.71.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.121.71.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20764 }
...
:if ([:len [/ip/route/find dst-address=81.27.249.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.27.249.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20764 }
:if ([:len [/ip/route/find dst-address=81.27.250.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.27.250.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20764 }
:if ([:len [/ip/route/find dst-address=81.27.252.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.27.252.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20764 }
