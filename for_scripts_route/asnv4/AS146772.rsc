...
:if ([:len [/ip/route/find dst-address=124.14.49.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=124.14.49.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS146772 }
:if ([:len [/ip/route/find dst-address=124.14.50.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=124.14.50.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS146772 }
:if ([:len [/ip/route/find dst-address=211.161.109.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=211.161.109.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS146772 }
