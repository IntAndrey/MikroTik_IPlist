...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=75.111.224.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=75.111.224.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19108 }
:if ([:len [/ip/route/find dst-address=75.111.226.0/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=75.111.226.0/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19108 }
:if ([:len [/ip/route/find dst-address=75.111.226.112/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=75.111.226.112/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19108 }
