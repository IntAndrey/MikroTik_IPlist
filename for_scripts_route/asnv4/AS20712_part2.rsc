...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=81.187.49.24/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.187.49.24/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20712 }
:if ([:len [/ip/route/find dst-address=81.187.49.28/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.187.49.28/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20712 }
:if ([:len [/ip/route/find dst-address=81.187.49.30/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.187.49.30/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20712 }
:if ([:len [/ip/route/find dst-address=81.187.49.32/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.187.49.32/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20712 }
:if ([:len [/ip/route/find dst-address=81.187.49.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.187.49.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20712 }
:if ([:len [/ip/route/find dst-address=81.187.50.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.187.50.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20712 }
:if ([:len [/ip/route/find dst-address=81.187.52.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.187.52.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20712 }
:if ([:len [/ip/route/find dst-address=81.187.56.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.187.56.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20712 }
