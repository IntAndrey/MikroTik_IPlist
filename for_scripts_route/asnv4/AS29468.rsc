...
:if ([:len [/ip/route/find dst-address=212.91.128.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.91.128.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29468 }
:if ([:len [/ip/route/find dst-address=212.91.148.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.91.148.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29468 }
:if ([:len [/ip/route/find dst-address=212.91.152.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.91.152.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29468 }
