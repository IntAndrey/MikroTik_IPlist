...
:if ([:len [/ip/route/find dst-address=114.112.232.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=114.112.232.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133929 }
:if ([:len [/ip/route/find dst-address=114.112.236.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=114.112.236.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133929 }
