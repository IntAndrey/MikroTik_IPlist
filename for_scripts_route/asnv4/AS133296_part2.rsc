...
:if ([:len [/ip/route/find dst-address=31.59.248.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.59.248.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133296 }
:if ([:len [/ip/route/find dst-address=31.59.252.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.59.252.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133296 }
