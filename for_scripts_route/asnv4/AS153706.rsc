...
:if ([:len [/ip/route/find dst-address=156.254.20.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.254.20.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153706 }
:if ([:len [/ip/route/find dst-address=163.223.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.223.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153706 }
