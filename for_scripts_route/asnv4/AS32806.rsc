...
:if ([:len [/ip/route/find dst-address=194.2.69.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.2.69.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32806 }
...
:if ([:len [/ip/route/find dst-address=74.119.210.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.119.210.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32806 }
