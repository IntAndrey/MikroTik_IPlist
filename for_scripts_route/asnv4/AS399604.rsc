...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=12.130.80.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=12.130.80.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399604 }
:if ([:len [/ip/route/find dst-address=12.227.225.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=12.227.225.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399604 }
