...
:if ([:len [/ip/route/find dst-address=204.0.64.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.0.64.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396168 }
...
:if ([:len [/ip/route/find dst-address=66.33.59.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.33.59.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396168 }
:if ([:len [/ip/route/find dst-address=66.33.78.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.33.78.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396168 }
