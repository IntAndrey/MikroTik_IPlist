...
:if ([:len [/ip/route/find dst-address=136.206.0.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.206.0.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1213 }
:if ([:len [/ip/route/find dst-address=136.206.12.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.206.12.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1213 }
:if ([:len [/ip/route/find dst-address=136.206.128.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.206.128.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1213 }
:if ([:len [/ip/route/find dst-address=136.206.14.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.206.14.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1213 }
:if ([:len [/ip/route/find dst-address=136.206.17.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.206.17.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1213 }
:if ([:len [/ip/route/find dst-address=136.206.18.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.206.18.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1213 }
:if ([:len [/ip/route/find dst-address=136.206.20.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.206.20.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1213 }
:if ([:len [/ip/route/find dst-address=136.206.24.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.206.24.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1213 }
:if ([:len [/ip/route/find dst-address=136.206.32.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.206.32.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1213 }
:if ([:len [/ip/route/find dst-address=136.206.64.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.206.64.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1213 }
:if ([:len [/ip/route/find dst-address=136.206.8.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.206.8.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1213 }
