...
:if ([:len [/ip/route/find dst-address=87.199.160.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.199.160.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43372 }
...
:if ([:len [/ip/route/find dst-address=91.209.177.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.209.177.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43372 }
