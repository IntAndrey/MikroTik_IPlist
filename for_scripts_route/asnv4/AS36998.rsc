...
:if ([:len [/ip/route/find dst-address=41.223.200.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.223.200.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36998 }
:if ([:len [/ip/route/find dst-address=41.223.202.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.223.202.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36998 }
...
:if ([:len [/ip/route/find dst-address=41.95.154.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.95.154.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36998 }
...
:if ([:len [/ip/route/find dst-address=41.95.255.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.95.255.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36998 }
