...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=124.42.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=124.42.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19793 }
:if ([:len [/ip/route/find dst-address=124.42.164.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=124.42.164.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19793 }
