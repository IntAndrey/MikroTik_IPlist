...
:if ([:len [/ip/route/find dst-address=195.88.52.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.88.52.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28761 }
...
:if ([:len [/ip/route/find dst-address=91.232.119.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.232.119.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28761 }
