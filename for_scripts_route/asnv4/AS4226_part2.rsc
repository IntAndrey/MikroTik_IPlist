...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=38.59.198.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.59.198.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4226 }
:if ([:len [/ip/route/find dst-address=38.59.200.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.59.200.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4226 }
