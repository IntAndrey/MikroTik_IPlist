...
:if ([:len [/ip/route/find dst-address=46.56.52.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.56.52.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25106 }
