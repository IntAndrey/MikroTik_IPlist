...
:if ([:len [/ip/route/find dst-address=153.55.184.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.55.184.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208770 }
