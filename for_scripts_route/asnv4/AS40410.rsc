...
:if ([:len [/ip/route/find dst-address=199.169.190.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.169.190.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40410 }
...
:if ([:len [/ip/route/find dst-address=199.169.40.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.169.40.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40410 }
:if ([:len [/ip/route/find dst-address=199.169.44.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.169.44.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40410 }
