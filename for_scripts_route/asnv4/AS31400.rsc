...
:if ([:len [/ip/route/find dst-address=77.37.77.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.37.77.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31400 }
:if ([:len [/ip/route/find dst-address=77.37.84.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.37.84.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31400 }
