...
:if ([:len [/ip/route/find dst-address=160.137.111.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.137.111.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3 }
:if ([:len [/ip/route/find dst-address=160.137.193.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.137.193.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3 }
:if ([:len [/ip/route/find dst-address=160.137.211.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.137.211.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3 }
...
:if ([:len [/ip/route/find dst-address=193.242.190.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.242.190.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3 }
:if ([:len [/ip/route/find dst-address=38.126.196.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.126.196.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3 }
