...
:if ([:len [/ip/route/find dst-address=103.240.216.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.240.216.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215731 }
:if ([:len [/ip/route/find dst-address=103.240.218.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.240.218.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215731 }
:if ([:len [/ip/route/find dst-address=103.243.36.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.243.36.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215731 }
...
:if ([:len [/ip/route/find dst-address=185.100.40.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.100.40.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215731 }
...
:if ([:len [/ip/route/find dst-address=43.228.198.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.228.198.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215731 }
