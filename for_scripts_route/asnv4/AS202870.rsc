...
:if ([:len [/ip/route/find dst-address=130.78.32.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.78.32.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202870 }
:if ([:len [/ip/route/find dst-address=130.78.48.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.78.48.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202870 }
