...
:if ([:len [/ip/route/find dst-address=203.115.208.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.115.208.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10204 }
:if ([:len [/ip/route/find dst-address=203.115.224.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.115.224.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10204 }
