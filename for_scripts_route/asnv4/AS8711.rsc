...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=109.202.8.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.202.8.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8711 }
:if ([:len [/ip/route/find dst-address=46.229.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.229.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8711 }
