...
:if ([:len [/ip/route/find dst-address=213.248.192.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.248.192.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43519 }
:if ([:len [/ip/route/find dst-address=213.248.194.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.248.194.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43519 }
