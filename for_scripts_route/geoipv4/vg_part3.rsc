...
:if ([:len [/ip/route/find dst-address=76.76.168.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.76.168.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=vg }
:if ([:len [/ip/route/find dst-address=76.76.169.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.76.169.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=vg }
:if ([:len [/ip/route/find dst-address=76.76.170.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.76.170.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=vg }
