...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=5.175.190.156/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.175.190.156/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=vi }
:if ([:len [/ip/route/find dst-address=5.175.190.160/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.175.190.160/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=vi }
:if ([:len [/ip/route/find dst-address=5.175.190.192/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.175.190.192/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=vi }
...
:if ([:len [/ip/route/find dst-address=65.112.145.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.112.145.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=vi }
:if ([:len [/ip/route/find dst-address=65.112.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.112.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=vi }
:if ([:len [/ip/route/find dst-address=65.112.148.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.112.148.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=vi }
