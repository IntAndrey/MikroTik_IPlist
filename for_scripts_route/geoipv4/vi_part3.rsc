...
:if ([:len [/ip/route/find dst-address=76.76.166.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.76.166.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=vi }
