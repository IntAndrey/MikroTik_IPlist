...
:if ([:len [/ip/route/find dst-address=96.9.176.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.9.176.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=hk }
:if ([:len [/ip/route/find dst-address=96.9.179.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.9.179.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=hk }
:if ([:len [/ip/route/find dst-address=96.9.180.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.9.180.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=hk }
:if ([:len [/ip/route/find dst-address=96.9.182.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.9.182.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=hk }
