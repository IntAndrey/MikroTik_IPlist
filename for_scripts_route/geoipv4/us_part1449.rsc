...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=99.92.240.32/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.92.240.32/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=us }
:if ([:len [/ip/route/find dst-address=99.92.240.40/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.92.240.40/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=us }
:if ([:len [/ip/route/find dst-address=99.92.240.42/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.92.240.42/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=us }
:if ([:len [/ip/route/find dst-address=99.92.240.44/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.92.240.44/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=us }
:if ([:len [/ip/route/find dst-address=99.92.240.48/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.92.240.48/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=us }
:if ([:len [/ip/route/find dst-address=99.92.240.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.92.240.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=us }
:if ([:len [/ip/route/find dst-address=99.92.241.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.92.241.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=us }
:if ([:len [/ip/route/find dst-address=99.92.242.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.92.242.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=us }
:if ([:len [/ip/route/find dst-address=99.92.244.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.92.244.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=us }
:if ([:len [/ip/route/find dst-address=99.92.248.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.92.248.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=us }
:if ([:len [/ip/route/find dst-address=99.93.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.93.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=us }
:if ([:len [/ip/route/find dst-address=99.94.0.0/15 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.94.0.0/15 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=us }
