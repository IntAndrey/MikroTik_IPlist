...
:if ([:len [/ip/route/find dst-address=66.234.153.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.234.153.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=mo }
