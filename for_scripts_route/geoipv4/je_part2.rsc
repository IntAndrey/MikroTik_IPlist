...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=213.167.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.167.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=je }
...
:if ([:len [/ip/route/find dst-address=9.246.82.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=9.246.82.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=je }
