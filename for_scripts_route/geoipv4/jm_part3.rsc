...
:if ([:len [/ip/route/find dst-address=66.54.125.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.54.125.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jm }
...
:if ([:len [/ip/route/find dst-address=67.213.158.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.213.158.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jm }
:if ([:len [/ip/route/find dst-address=67.230.43.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.230.43.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jm }
...
:if ([:len [/ip/route/find dst-address=72.252.191.39/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.252.191.39/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jm }
:if ([:len [/ip/route/find dst-address=72.252.198.234/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.252.198.234/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jm }
:if ([:len [/ip/route/find dst-address=72.252.252.110/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.252.252.110/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jm }
...
:if ([:len [/ip/route/find dst-address=95.142.123.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.142.123.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jm }
