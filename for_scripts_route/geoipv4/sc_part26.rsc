...
:if ([:len [/ip/route/find dst-address=91.214.119.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.214.119.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=sc }
...
:if ([:len [/ip/route/find dst-address=91.235.158.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.235.158.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=sc }
...
:if ([:len [/ip/route/find dst-address=91.243.188.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.243.188.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=sc }
...
:if ([:len [/ip/route/find dst-address=92.118.187.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.118.187.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=sc }
:if ([:len [/ip/route/find dst-address=92.119.162.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.119.162.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=sc }
:if ([:len [/ip/route/find dst-address=92.119.194.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.119.194.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=sc }
...
:if ([:len [/ip/route/find dst-address=93.157.110.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.157.110.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=sc }
:if ([:len [/ip/route/find dst-address=93.190.244.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.190.244.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=sc }
:if ([:len [/ip/route/find dst-address=94.103.178.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.103.178.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=sc }
:if ([:len [/ip/route/find dst-address=94.103.189.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.103.189.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=sc }
:if ([:len [/ip/route/find dst-address=94.103.191.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.103.191.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=sc }
...
:if ([:len [/ip/route/find dst-address=94.158.20.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.158.20.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=sc }
