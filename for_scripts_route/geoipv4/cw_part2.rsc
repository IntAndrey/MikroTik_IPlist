...
:if ([:len [/ip/route/find dst-address=206.113.24.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.113.24.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cw }
...
:if ([:len [/ip/route/find dst-address=44.30.154.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=44.30.154.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cw }
...
:if ([:len [/ip/route/find dst-address=63.245.108.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=63.245.108.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cw }
