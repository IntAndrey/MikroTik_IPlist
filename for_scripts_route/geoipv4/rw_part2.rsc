...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=212.14.90.224/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.14.90.224/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=rw }
...
:if ([:len [/ip/route/find dst-address=41.173.168.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.173.168.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=rw }
:if ([:len [/ip/route/find dst-address=41.173.248.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.173.248.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=rw }
:if ([:len [/ip/route/find dst-address=41.173.28.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.173.28.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=rw }
...
:if ([:len [/ip/route/find dst-address=41.60.151.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.60.151.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=rw }
