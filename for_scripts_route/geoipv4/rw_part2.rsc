...
:if ([:len [/ip/route/find dst-address=41.216.96.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.216.96.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=rw }
