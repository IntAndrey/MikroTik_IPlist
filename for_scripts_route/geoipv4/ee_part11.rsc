...
:if ([:len [/ip/route/find dst-address=95.85.228.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.85.228.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ee }
