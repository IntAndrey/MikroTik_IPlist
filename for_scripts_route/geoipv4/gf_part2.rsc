...
:if ([:len [/ip/route/find dst-address=92.142.0.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.142.0.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=gf }
:if ([:len [/ip/route/find dst-address=92.142.48.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.142.48.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=gf }
:if ([:len [/ip/route/find dst-address=92.142.64.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.142.64.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=gf }
