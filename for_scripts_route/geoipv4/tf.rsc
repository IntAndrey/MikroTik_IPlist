...
:if ([:len [/ip/route/find dst-address=5.175.190.168/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.175.190.168/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=tf }
