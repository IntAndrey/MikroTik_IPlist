...
:if ([:len [/ip/route/find dst-address=66.197.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.197.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=netflix }
:if ([:len [/ip/route/find dst-address=66.197.136.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.197.136.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=netflix }
:if ([:len [/ip/route/find dst-address=66.197.147.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.197.147.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=netflix }
:if ([:len [/ip/route/find dst-address=66.197.148.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.197.148.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=netflix }
:if ([:len [/ip/route/find dst-address=66.197.154.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.197.154.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=netflix }
:if ([:len [/ip/route/find dst-address=66.197.156.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.197.156.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=netflix }
