...
:if ([:len [/ip/route/find dst-address=104.244.41.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.244.41.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=twitter }
...
:if ([:len [/ip/route/find dst-address=209.237.208.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.237.208.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=twitter }
